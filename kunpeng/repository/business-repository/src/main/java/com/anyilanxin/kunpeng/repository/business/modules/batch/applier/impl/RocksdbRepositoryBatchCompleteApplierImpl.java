 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryBatchCompleteApplierImpl
    implements RepositoryBatchApplier<ProcessInstanceBatchRecord> {

  private final MutableBatchRepository mutable;

  public RocksdbRepositoryBatchCompleteApplierImpl(final BusinessRepository repository) {
    mutable = repository.batchRepository();
  }

  @Override
  public ProcessInstanceBatchState valueState() {
    return ProcessInstanceBatchState.BATCH_COMPLETED;
  }
