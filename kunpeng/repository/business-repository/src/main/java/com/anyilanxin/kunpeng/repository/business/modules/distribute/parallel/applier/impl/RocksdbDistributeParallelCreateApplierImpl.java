 ...
 * @since 2026.9.0
 */
public class RocksdbDistributeParallelCreateApplierImpl
  ...
  public RocksdbDistributeParallelCreateApplierImpl(final BusinessRepository repository) {
  ...
  public void applyState(final long key, final DistributeParallelRecord recordValue) {
    distribute.save(key, recordValue);
  }

  @Override
  public DistributeParallelLifeCycle valueState() {
    return DistributeParallelLifeCycle.CREATE_DISTRIBUTED;
  }
}
