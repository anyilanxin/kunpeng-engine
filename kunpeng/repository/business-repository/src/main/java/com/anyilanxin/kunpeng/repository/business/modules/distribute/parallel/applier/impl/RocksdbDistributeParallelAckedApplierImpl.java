 ...
 * @since 2026.9.0
 */
public class RocksdbDistributeParallelAckedApplierImpl
  ...
  public RocksdbDistributeParallelAckedApplierImpl(final BusinessRepository repository) {
  ...
  public void applyState(final long key, final DistributeParallelRecord recordValue) {
    distribute.ackDistribute(key, recordValue.getCurrentDistributeIndex());
  }

  @Override
  public DistributeParallelLifeCycle valueState() {
    return DistributeParallelLifeCycle.DISTRIBUTE_ACKED;
  }
}
