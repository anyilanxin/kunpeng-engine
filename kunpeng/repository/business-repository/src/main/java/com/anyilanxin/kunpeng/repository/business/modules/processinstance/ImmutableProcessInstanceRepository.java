 ...
 * @since 2026.9.0
 */
public interface ImmutableProcessInstanceRepository extends ResourceDataSplit {

  ProcessInstanceRecord getRecord(final long key);

  int getSequenceCounter(final long key);
}
