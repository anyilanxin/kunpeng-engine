 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryUserTaskCreatingApplierImpl
    implements RepositoryUserTaskApplier<UserTaskRecord> {
  private final MutableUserTaskRepository userTask;

  public RocksdbRepositoryUserTaskCreatingApplierImpl(final BusinessRepository repository) {
