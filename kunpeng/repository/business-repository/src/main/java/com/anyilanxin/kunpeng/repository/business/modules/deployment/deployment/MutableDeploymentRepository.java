 ...
 * @since 2026.9.0
 */
public interface MutableDeploymentRepository extends ImmutableDeploymentRepository {
  void save(long key, DeploymentRecord record);

  void update(long key, DeploymentRecord record);
