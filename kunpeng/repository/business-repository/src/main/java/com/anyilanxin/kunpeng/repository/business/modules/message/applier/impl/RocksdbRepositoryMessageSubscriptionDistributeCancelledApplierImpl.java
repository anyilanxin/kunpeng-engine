 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryMessageSubscriptionDistributeCancelledApplierImpl
  ...
  public RocksdbRepositoryMessageSubscriptionDistributeCancelledApplierImpl(
  ...
  public MessageSubscriptionLifeCycle valueState() {
    return MessageSubscriptionLifeCycle.DISTRIBUTE_CANCELED;
  }

  @Override
  public void applyState(final long key, final MessageSubscriptionRecord record) {
    messageSubscription.cancelSubscription(record);
  }
}
