 ...
 * @since 2026.9.0
 */
public class RocksdbDistributeSerialAckedApplierImpl
  ...
  public RocksdbDistributeSerialAckedApplierImpl(final BusinessRepository repository) {
  ...
  public void applyState(final long key, final DistributeSerialRecord recordValue) {
    distribute.ackDistribute(key, recordValue.getCurrentDistributeSourceId());
  }

  @Override
  public DistributeSerialLifeCycle valueState() {
    return DistributeSerialLifeCycle.DISTRIBUTE_ACKED;
  }
}
