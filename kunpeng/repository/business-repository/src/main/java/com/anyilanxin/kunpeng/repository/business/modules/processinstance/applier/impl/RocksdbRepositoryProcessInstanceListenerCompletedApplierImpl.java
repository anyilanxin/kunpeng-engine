 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryProcessInstanceListenerCompletedApplierImpl
  ...
  public RocksdbRepositoryProcessInstanceListenerCompletedApplierImpl(
  ...
  public void applyState(final long key, final ProcessInstanceRecord recordValue) {
    processInstance.update(key, recordValue);
  }

  @Override
  public ProcessInstanceLifeCycle valueState() {
    return ProcessInstanceLifeCycle.LISTENER_COMPLETED;
  }
}
