 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryUserTaskTerminatingApplierImpl
    implements RepositoryUserTaskApplier<UserTaskRecord> {
  private final MutableUserTaskRepository userTask;

  public RocksdbRepositoryUserTaskTerminatingApplierImpl(final BusinessRepository repository) {
