 ...
 * @since 2026.9.0
 */
public interface RepositoryMessageDistributeCorrelateApplier<
        Record extends MessageDistributeCorrelateRecordValue>
  ...
  @Override
  MessageDistributeCorrelateLifeCycle valueState();
}
