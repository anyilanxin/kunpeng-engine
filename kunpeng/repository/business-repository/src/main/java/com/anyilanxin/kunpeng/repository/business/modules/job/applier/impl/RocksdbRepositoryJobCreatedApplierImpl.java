 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryJobCreatedApplierImpl implements RepositoryJobApplier<JobRecord> {
  private final MutableJobRepository job;

  public RocksdbRepositoryJobCreatedApplierImpl(final BusinessRepository repository) {
    job = repository.jobRepository();
  }

  @Override
  public JobLifeCycle valueState() {
    return JobLifeCycle.CREATED;
  }

  @Override
  public void applyState(final long key, final JobRecord recordValue) {
    job.save(key, recordValue);
  }
}
