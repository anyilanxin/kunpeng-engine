 ...
 * @since 2026.9.0
 */
public interface ImmutableAsyncRepository extends ResourceDataSplit {
  Optional<AsyncRequestRecord> query(long key, ValueType valueType, ValueLifeCycle valueLifeCycle);
}
