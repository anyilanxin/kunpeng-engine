 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryActivityInstanceTerminatedApplierImpl
  ...
  public RocksdbRepositoryActivityInstanceTerminatedApplierImpl(
  ...
  public void applyState(final long key, final ActivityInstanceRecord recordValue) {
    activityInstance.delete(
        recordValue.getProcessInstanceId(), recordValue.getParentActivityInstanceId(), key);
  }

  @Override
  public ActivityInstanceLifeCycle valueState() {
    return ActivityInstanceLifeCycle.TERMINATED;
  }
}
