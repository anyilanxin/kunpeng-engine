 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryVariableRemovedApplierImpl
    implements RepositoryVariableApplier<VariableRecord> {
  private final MutableVariableRepository variable;

  public RocksdbRepositoryVariableRemovedApplierImpl(final BusinessRepository repository) {
  ...
  public VariableLifeCycle valueState() {
    return VariableLifeCycle.REMOVED;
  }
}
