 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryIncidentDeletedApplierImpl
    implements RepositoryIncidentApplier<IncidentRecord> {
  private final MutableIncidentRepository incident;

  public RocksdbRepositoryIncidentDeletedApplierImpl(final BusinessRepository repository) {
    incident = repository.incidentRepository();
  }

  @Override
  public IncidentLifeCycle valueState() {
    return IncidentLifeCycle.DELETED;
  }
