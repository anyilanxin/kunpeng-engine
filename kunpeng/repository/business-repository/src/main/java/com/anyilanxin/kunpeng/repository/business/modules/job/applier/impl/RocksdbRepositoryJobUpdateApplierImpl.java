 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryJobUpdateApplierImpl implements RepositoryJobApplier<JobRecord> {
  private final MutableJobRepository job;

  public RocksdbRepositoryJobUpdateApplierImpl(final BusinessRepository repository) {
    job = repository.jobRepository();
  }

  @Override
  public JobLifeCycle valueState() {
    return JobLifeCycle.UPDATED;
  }
