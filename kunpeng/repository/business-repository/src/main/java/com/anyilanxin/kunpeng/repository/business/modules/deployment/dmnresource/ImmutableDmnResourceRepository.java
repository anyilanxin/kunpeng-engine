 ...
 * @since 2026.9.0
 */
public interface ImmutableDmnResourceRepository extends ResourceDataSplit {
  DecisionDefinitionRecord getDecision(long key);

  void getDecision(long key, DeploymentRecord record);

  int getDecisionVersion(final String decisionDefinitionKey, final String tenantId);

  DecisionRequirementDefinitionRecord getDecisionRequirement(long key);

  void getDecisionRequirement(long key, DeploymentRecord record);

  int getDecisionRequirementVersion(
