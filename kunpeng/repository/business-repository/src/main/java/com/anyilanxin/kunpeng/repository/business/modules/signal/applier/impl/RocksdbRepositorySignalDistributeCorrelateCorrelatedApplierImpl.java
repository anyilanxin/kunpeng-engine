 ...
 * @since 2026.9.0
 */
public class RocksdbRepositorySignalDistributeCorrelateCorrelatedApplierImpl
  ...
  public RocksdbRepositorySignalDistributeCorrelateCorrelatedApplierImpl(
  ...
  public SignalDistributeCorrelateLifeCycle valueState() {
    return SignalDistributeCorrelateLifeCycle.CORRELATED;
  }

  @Override
  public void applyState(final long key, final SignalDistributeCorrelateRecord record) {
    signalSubscription.deleteCorrelate(key);
  }
}
