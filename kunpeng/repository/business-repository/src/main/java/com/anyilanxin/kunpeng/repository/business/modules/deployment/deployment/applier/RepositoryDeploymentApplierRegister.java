 ...
 */
package com.anyilanxin.kunpeng.repository.business.modules.deployment.deployment.applier;
 ...
 * @since 2026.9.0
 */
public class RepositoryDeploymentApplierRegister {
  ...
  public static void register(
    ...
    appliers
        ...
        .register(new RocksdbRepositoryCreateProcessDefinitionApplierImpl(repository))
        .register(new RocksdbRepositoryFromDistributeCreateProcessDefinitionApplierImpl(repository))
        .register(new RocksdbRepositoryDeleteProcessDefinitionApplierImpl(repository))
        .register(new RocksdbRepositoryDeploymentCreateApplierImpl(repository))
        .register(new RocksdbRepositoryDeploymentDeleteApplierImpl(repository))
        .register(new RocksdbRepositorySuspendProcessDefinitionApplierImpl(repository));
  }
}
