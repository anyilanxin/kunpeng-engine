 ...
 * @since 2026.9.0
 */
public class RocksdbDistributeSerialCompletedApplierImpl
  ...
  public RocksdbDistributeSerialCompletedApplierImpl(final BusinessRepository repository) {
  ...
  public DistributeSerialLifeCycle valueState() {
    return DistributeSerialLifeCycle.DISTRIBUTE_COMPLETED;
  }
}
