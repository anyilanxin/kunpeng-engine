 ...
 * @since 2026.9.0
 */
public interface RepositorySignalDistributeCorrelateApplier<
        Record extends SignalDistributeCorrelateRecordValue>
  ...
  @Override
  SignalDistributeCorrelateLifeCycle valueState();
}
