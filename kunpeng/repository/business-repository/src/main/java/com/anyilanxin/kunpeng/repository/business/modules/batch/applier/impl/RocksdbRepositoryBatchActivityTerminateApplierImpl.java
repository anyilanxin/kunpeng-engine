 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryBatchActivityTerminateApplierImpl
    implements RepositoryBatchApplier<ProcessInstanceBatchRecord> {
  private final MutableBatchRepository mutable;

  public RocksdbRepositoryBatchActivityTerminateApplierImpl(final BusinessRepository repository) {
