 ...
 * @since 2026.9.0
 */
public class RocksdbDistributeSerialAfterStartedApplierImpl
  ...
  public RocksdbDistributeSerialAfterStartedApplierImpl(final BusinessRepository repository) {
  ...
  public DistributeSerialLifeCycle valueState() {
    return DistributeSerialLifeCycle.DISTRIBUTE_AFTER_STARTED;
  }
}
