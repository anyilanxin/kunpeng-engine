...
public class DistributeSerialIndexRecordEntity extends UnpackedObject implements StoreValue {
  ...
  public DistributeSerialIndexRecordEntity() {
    super(2);
    // formatting:off
  ...
  public DistributeSerialIndexRecordEntity setDistributeId(final long distributeId) {
  ...
  public DistributeSerialIndexRecordEntity setDistributeIndex(
  ...
  public DistributeSerialIndexRecordEntity removeDistributeIndex(final Integer distributeIndex) {
