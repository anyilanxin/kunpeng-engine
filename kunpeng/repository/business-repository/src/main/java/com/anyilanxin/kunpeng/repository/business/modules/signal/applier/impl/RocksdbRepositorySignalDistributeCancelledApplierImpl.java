 ...
 * @since 2026.9.0
 */
public class RocksdbRepositorySignalDistributeCancelledApplierImpl
    implements RepositorySignalApplier<SignalSubscriptionRecord> {
  private final MutableSignalEventRepository signalSubscription;

  public RocksdbRepositorySignalDistributeCancelledApplierImpl(
  ...
  public SignalSubscriptionLifeCycle valueState() {
    return SignalSubscriptionLifeCycle.DISTRIBUTE_CANCELED;
  }
