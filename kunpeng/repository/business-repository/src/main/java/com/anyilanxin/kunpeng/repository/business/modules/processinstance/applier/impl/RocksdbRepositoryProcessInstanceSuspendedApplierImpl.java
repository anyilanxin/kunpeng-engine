 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryProcessInstanceSuspendedApplierImpl
  ...
  public RocksdbRepositoryProcessInstanceSuspendedApplierImpl(final BusinessRepository repository) {
  ...
  public void applyState(final long key, final ProcessInstanceRecord recordValue) {
    final ProcessInstanceRecord record = processInstance.getRecord(key);
    //    record.setState(false);
    processInstance.update(key, record);
  }

  @Override
  public ProcessInstanceLifeCycle valueState() {
    return ProcessInstanceLifeCycle.SUSPENDED;
  }
}
