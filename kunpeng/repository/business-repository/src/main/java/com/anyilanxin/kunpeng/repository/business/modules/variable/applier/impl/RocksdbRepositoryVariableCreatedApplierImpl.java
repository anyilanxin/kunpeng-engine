 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryVariableCreatedApplierImpl
    implements RepositoryVariableApplier<VariableRecord> {
  private final MutableVariableRepository variable;

  public RocksdbRepositoryVariableCreatedApplierImpl(final BusinessRepository repository) {
  ...
  public VariableLifeCycle valueState() {
    return VariableLifeCycle.CREATED;
  }
}
