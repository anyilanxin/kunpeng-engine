 ...
 * @since 2026.9.0
 */
public interface ImmutableByteArrayResourceRepository extends ResourceDataSplit {
  ResourceDefinitionRecord get(long key);

  void get(long key, DeploymentRecord record);
}
