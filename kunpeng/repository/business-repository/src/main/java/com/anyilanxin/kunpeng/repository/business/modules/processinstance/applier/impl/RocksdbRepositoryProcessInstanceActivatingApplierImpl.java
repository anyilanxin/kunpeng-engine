 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryProcessInstanceActivatingApplierImpl
  ...
  public RocksdbRepositoryProcessInstanceActivatingApplierImpl(
  ...
  public void applyState(final long key, final ProcessInstanceRecord recordValue) {
    processInstance.save(key, recordValue);
  }
