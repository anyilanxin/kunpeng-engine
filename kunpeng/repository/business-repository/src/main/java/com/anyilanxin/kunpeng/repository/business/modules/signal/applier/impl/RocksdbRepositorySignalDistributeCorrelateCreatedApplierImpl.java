 ...
 * @since 2026.9.0
 */
public class RocksdbRepositorySignalDistributeCorrelateCreatedApplierImpl
  ...
  public RocksdbRepositorySignalDistributeCorrelateCreatedApplierImpl(
  ...
  public SignalDistributeCorrelateLifeCycle valueState() {
    return SignalDistributeCorrelateLifeCycle.CREATED;
  }

  @Override
  public void applyState(final long key, final SignalDistributeCorrelateRecord record) {
    signalSubscription.saveCorrelate(key, record);
  }
}
