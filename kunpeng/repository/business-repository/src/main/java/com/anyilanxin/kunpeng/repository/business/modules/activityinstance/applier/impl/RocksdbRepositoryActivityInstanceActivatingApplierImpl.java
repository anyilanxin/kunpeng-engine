 ...
 * @since 2026.9.0
 */
public class RocksdbRepositoryActivityInstanceActivatingApplierImpl
  ...
  public RocksdbRepositoryActivityInstanceActivatingApplierImpl(
  ...
  public void applyState(final long key, final ActivityInstanceRecord recordValue) {
    activityInstance.save(key, recordValue);
  }

  @Override
  public ActivityInstanceLifeCycle valueState() {
    return ActivityInstanceLifeCycle.ACTIVATING;
  }
}
