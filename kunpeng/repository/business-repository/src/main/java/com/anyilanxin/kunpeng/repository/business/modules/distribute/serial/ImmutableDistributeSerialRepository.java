 ...
 * @since 2026.9.0
 */
public interface ImmutableDistributeSerialRepository extends ResourceDataSplit {

  DistributeSerialRecord getDistribute(long key);
  ...
  interface WaitDistributionVisitor {
    boolean visit(final long distributionKey, final DistributeSerialRecord distributeRecord);
  }
}
