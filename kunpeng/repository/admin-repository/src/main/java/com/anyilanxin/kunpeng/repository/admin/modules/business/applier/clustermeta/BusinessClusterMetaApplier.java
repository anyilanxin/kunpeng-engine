 ...
 */
package com.anyilanxin.kunpeng.repository.admin.modules.business.applier.clustermeta;
...
/**
 * 业务面集群元数据 Record 应用器接口。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public interface BusinessClusterMetaApplier extends AdminApplier<BusinessClusterMetaRecord> {
  @Override
  ...
  @Override
  BusinessClusterMetaLifeCycle lifeCycle();
}
