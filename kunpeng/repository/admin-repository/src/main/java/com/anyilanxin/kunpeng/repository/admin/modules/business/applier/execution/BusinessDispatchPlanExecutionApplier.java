 ...
 */
package com.anyilanxin.kunpeng.repository.admin.modules.business.applier.execution;
...
/**
 * 业务面调度执行明细 Record 应用器接口。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public interface BusinessDispatchPlanExecutionApplier
    extends AdminApplier<BusinessDispatchPlanExecutionRecord> {
  @Override
  ...
  @Override
  BusinessDispatchPlanExecutionLifeCycle lifeCycle();
}
