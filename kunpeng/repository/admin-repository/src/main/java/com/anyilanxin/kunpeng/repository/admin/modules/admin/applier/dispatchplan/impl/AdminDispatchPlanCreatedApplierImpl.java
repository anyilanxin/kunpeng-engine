 ...
 * @since
 */
public class AdminDispatchPlanCreatedApplierImpl implements AdminDispatchPlanApplier {
  private final MutableRepositoryAdmin repositoryAdmin;

  public AdminDispatchPlanCreatedApplierImpl(final AdminRepository repository) {
  ...
  public AdminDispatchPlanLifeCycle lifeCycle() {
    return AdminDispatchPlanLifeCycle.PLAN_CREATED;
  }
}
