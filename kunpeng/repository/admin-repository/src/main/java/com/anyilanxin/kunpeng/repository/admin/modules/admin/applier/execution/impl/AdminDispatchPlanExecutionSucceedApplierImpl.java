 ...
 * @since
 */
public class AdminDispatchPlanExecutionSucceedApplierImpl
    implements AdminDispatchPlanExecutionApplier {
  private final MutableRepositoryAdmin repositoryAdmin;

  public AdminDispatchPlanExecutionSucceedApplierImpl(final AdminRepository repository) {
  ...
  public void applyState(final long key, final AdminDispatchPlanExecutionRecord recordValue) {
    repositoryAdmin.dispatchPlanExecutionSuccess(key, recordValue);
  }

  @Override
  public AdminDispatchPlanExecutionLifeCycle lifeCycle() {
    return AdminDispatchPlanExecutionLifeCycle.SUCCEED;
  }
}
