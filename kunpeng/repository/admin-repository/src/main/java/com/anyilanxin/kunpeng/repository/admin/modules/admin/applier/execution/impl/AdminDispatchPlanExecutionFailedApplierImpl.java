 ...
 * @since
 */
public class AdminDispatchPlanExecutionFailedApplierImpl
  ...
  public void applyState(final long key, final AdminDispatchPlanExecutionRecord recordValue) {
    repositoryAdmin.dispatchPlanExecutionFail(key, recordValue);
  }

  @Override
  public AdminDispatchPlanExecutionLifeCycle lifeCycle() {
    return AdminDispatchPlanExecutionLifeCycle.FAILED;
  }
}
