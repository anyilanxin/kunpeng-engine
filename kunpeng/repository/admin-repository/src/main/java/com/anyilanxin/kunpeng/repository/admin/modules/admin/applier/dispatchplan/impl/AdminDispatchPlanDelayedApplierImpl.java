 ...
 * @since
 */
public class AdminDispatchPlanDelayedApplierImpl implements AdminDispatchPlanApplier {
  private final MutableRepositoryAdmin repositoryAdmin;

  public AdminDispatchPlanDelayedApplierImpl(final AdminRepository repository) {
  ...
  public void applyState(final long key, final AdminDispatchPlanRecord recordValue) {
    repositoryAdmin.saveDispatchPlan(recordValue);
  }

  @Override
  public AdminDispatchPlanLifeCycle lifeCycle() {
    return AdminDispatchPlanLifeCycle.PLAN_DELAYED;
  }
}
