 ...
 */
package com.anyilanxin.kunpeng.repository.admin.modules.source.applier.partitionsourcemeta;
...
/**
 * 分区 source 元数据 Record 应用器接口。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public interface PartitionSourceMetaApplier extends AdminApplier<PartitionSourceMetaRecord> {
  @Override
  ...
  @Override
  PartitionSourceMetaLifeCycle lifeCycle();
}
