 ...
 * @since
 */
public class BusinessDispatchPlanFailedApplierImpl implements BusinessDispatchPlanApplier {
  private final MutableRepositoryBusiness repositoryBusiness;

  public BusinessDispatchPlanFailedApplierImpl(final AdminRepository repository) {
  ...
  public void applyState(final long key, final BusinessDispatchPlanRecord recordValue) {
    repositoryBusiness.dispatchPlanComplete(key);
  }

  @Override
  public BusinessDispatchPlanLifeCycle lifeCycle() {
    return BusinessDispatchPlanLifeCycle.FAILED;
  }
}
