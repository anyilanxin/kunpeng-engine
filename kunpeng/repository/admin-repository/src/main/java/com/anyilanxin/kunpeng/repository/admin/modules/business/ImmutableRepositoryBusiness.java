 ...
 * @since
 */
public interface ImmutableRepositoryBusiness {

  List<PartitionInfoMetaRecord> getPartitionInfoMeta(String memberId);

  BusinessClusterMetaRecord getClusterMeta();

  PartitionInfoMetaRecord getPartitionMeta(String partitionGroup, int partitionId);

  BusinessDispatchPlanRecord getDispatchPlan(final long dispatchPlanId);

  BusinessDispatchPlanExecutionRecord getDispatchPlanExecution(
      final long dispatchPlanId, final long dispatchPlanExecutionId);

  BusinessDispatchPlanExecutionRecord getNextDispatchPlanExecution(final long dispatchPlanId);
}
