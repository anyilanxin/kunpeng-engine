 ...
 * @since
 */
public class BusinessDispatchPlanExecutionExecutedApplierImpl
    implements BusinessDispatchPlanExecutionApplier {
  private final MutableRepositoryBusiness repositoryBusiness;

  public BusinessDispatchPlanExecutionExecutedApplierImpl(final AdminRepository repository) {
  ...
  public void applyState(final long key, final BusinessDispatchPlanExecutionRecord recordValue) {
    repositoryBusiness.dispatchPlanExecution(recordValue);
  }

  @Override
  public BusinessDispatchPlanExecutionLifeCycle lifeCycle() {
    return BusinessDispatchPlanExecutionLifeCycle.EXECUTED;
  }
}
