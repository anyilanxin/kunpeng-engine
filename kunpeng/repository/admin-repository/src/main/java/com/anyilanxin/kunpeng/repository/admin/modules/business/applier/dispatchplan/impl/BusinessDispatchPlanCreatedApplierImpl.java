 ...
 * @since
 */
public class BusinessDispatchPlanCreatedApplierImpl implements BusinessDispatchPlanApplier {
  private final MutableRepositoryBusiness repositoryBusiness;

  public BusinessDispatchPlanCreatedApplierImpl(final AdminRepository repository) {
  ...
  public BusinessDispatchPlanLifeCycle lifeCycle() {
    return BusinessDispatchPlanLifeCycle.PLAN_CREATED;
  }
}
