 ...
 * @since
 */
public class BusinessClusterMetaDeletedApplierImpl implements BusinessClusterMetaApplier {
  private final MutableRepositoryBusiness repositoryBusiness;

  public BusinessClusterMetaDeletedApplierImpl(final AdminRepository repository) {
  ...
  public BusinessClusterMetaLifeCycle lifeCycle() {
    return BusinessClusterMetaLifeCycle.DELETED;
  }
}
