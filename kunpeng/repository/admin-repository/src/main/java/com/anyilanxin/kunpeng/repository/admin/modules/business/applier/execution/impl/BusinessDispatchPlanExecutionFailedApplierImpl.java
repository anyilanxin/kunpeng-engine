 ...
 * @since
 */
public class BusinessDispatchPlanExecutionFailedApplierImpl
  ...
  public void applyState(final long key, final BusinessDispatchPlanExecutionRecord recordValue) {
    repositoryBusiness.dispatchPlanExecutionFail(key, recordValue);
  }

  @Override
  public BusinessDispatchPlanExecutionLifeCycle lifeCycle() {
    return BusinessDispatchPlanExecutionLifeCycle.FAILED;
  }
}
