...
public class ZonedDateTimeFunction implements QLFunction {
  ...
  public Object call(final QContext qContext, final Parameters parameters) throws Throwable {
    return switch (parameters.size()) {
      case 0 -> ZonedDateTime.now();
      case 1 -> format(parameters.getValue(0), DateTimeFormatter.ISO_ZONED_DATE_TIME);
      case 2 -> format(parameters.getValue(0), parameters.getValue(1));
      default -> null;
    };
  }

  private ZonedDateTime format(final Object value, final Object format) {
    if (format == null) {
      return null;
    }
  ...
  private ZonedDateTime format(final Object value, final DateTimeFormatter formatter) {
    if (value == null) {
      return null;
    }
