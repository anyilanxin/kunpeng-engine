...
/**
 * time() time(string) time(string, format)
 *
 * @author zxuanhong
 * @date 2025-11-11 10:22
 * @since
 */
public class TimeFunction implements QLFunction {
  @Override
  public Object call(final QContext qContext, final Parameters parameters) throws Throwable {
    return switch (parameters.size()) {
      case 0 -> LocalTime.now();
  ...
  private LocalTime format(final Object value, final Object format) {
    if (format == null) {
      return null;
    }
  ...
  private LocalTime format(final Object value, final DateTimeFormatter formatter) {
    if (value == null) {
      return null;
    }
    if (formatter == null) {
