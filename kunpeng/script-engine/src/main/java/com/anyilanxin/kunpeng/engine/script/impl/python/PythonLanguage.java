...
public final class PythonLanguage implements ScriptLanguage {
  ...
  public PythonLanguage(final ScriptEngineManager engineManager) {
    engine = (PyScriptEngine) engineManager.getEngineByName(Language.PYTHON.getShortName());
  }

  @Override
  public ScriptExpression parse(final String expression) {
    return new PythonExpression(engine, expression);
  }
}
