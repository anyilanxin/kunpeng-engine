...
import com.anyilanxin.kunpeng.protocol.admin.record.command.common.PartitionStopRecordValue;
...
public class PartitionStopRecord extends UnifiedRecordValue<PartitionStopRecord>
  ...
  public PartitionStopRecord setDispatchPlanId(final long dispatchPlanId) {
  ...
  public PartitionStopRecord setDispatchPlanExecutionId(final long dispatchPlanExecutionId) {
  ...
  public PartitionStopRecord setPartitionType(final PartitionType partitionType) {
  ...
  public PartitionStopRecord setExecutionType(final PartitionExecutionType executionType) {
  ...
  public PartitionStopRecord setExecutionMemberId(final String executionMemberId) {
  ...
  public PartitionStopRecord setExecutionMemberId(final DirectBuffer executionMemberId) {
  ...
  public PartitionStopRecord setPartitionGroup(final String partitionGroup) {
  ...
  public PartitionStopRecord setPartitionGroup(final DirectBuffer partitionGroup) {
  ...
  public PartitionStopRecord setPartitionId(final int partitionId) {
    partitionIdProp.setValue(partitionId);
    return this;
  }

  public PartitionStopRecord fromPartitionId(final PartitionId partitionId) {
  ...
  @Override
  protected PartitionStopRecord newRecord() {
