...
import com.anyilanxin.kunpeng.protocol.admin.record.command.common.PartitionLeaveRecordValue;
...
/**
 * 分区离开命令记录，携带分区类型、执行类型、发起执行的节点 ID 及目标分区组与分区 ID。
 *
 * @author zxuanhong
 * @since
 */
@AutoDeclareProperties
public class PartitionLeaveRecord extends UnifiedRecordValue<PartitionLeaveRecord>
    implements PartitionLeaveRecordValue {
  ...
  private final EnumProperty<PartitionExecutionType> executionTypeProp =
      new EnumProperty<>(
          2, "EXECUTION_TYPE", PartitionExecutionType.class, PartitionExecutionType.LEAVE);
  ...
  public PartitionLeaveRecord setDispatchPlanId(final long dispatchPlanId) {
  ...
  public PartitionLeaveRecord setDispatchPlanExecutionId(final long dispatchPlanExecutionId) {
  ...
  public PartitionLeaveRecord setPartitionType(final PartitionType partitionType) {
  ...
  public PartitionLeaveRecord setExecutionType(final PartitionExecutionType executionType) {
  ...
  public PartitionLeaveRecord setExecutionMemberId(final String executionMemberId) {
  ...
  public PartitionLeaveRecord setExecutionMemberId(final DirectBuffer executionMemberId) {
  ...
  public PartitionLeaveRecord setPartitionGroup(final String partitionGroup) {
  ...
  public PartitionLeaveRecord setPartitionGroup(final DirectBuffer partitionGroup) {
  ...
  public PartitionLeaveRecord setPartitionId(final int partitionId) {
    partitionIdProp.setValue(partitionId);
    return this;
  }

  public PartitionLeaveRecord fromPartitionId(final PartitionId partitionId) {
  ...
  @Override
  protected PartitionLeaveRecord newRecord() {
