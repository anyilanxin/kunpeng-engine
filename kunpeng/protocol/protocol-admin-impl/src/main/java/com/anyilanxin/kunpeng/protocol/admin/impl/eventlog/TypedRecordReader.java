...
import com.anyilanxin.kunpeng.protocol.admin.AdminEventRecord;
...
/**
 * {@link AdminLogRecord} 的 logstreams 视图（替代旧模块的 LogRecordImpl）： 消费方在处理循环里 {@code
 ...
 * @since 2026.9.0
 */
public final class TypedRecordReader implements AdminLogRecord {
  ...
  @Override
  public AdminEventRecord copyOf() {
    return null;
  }
