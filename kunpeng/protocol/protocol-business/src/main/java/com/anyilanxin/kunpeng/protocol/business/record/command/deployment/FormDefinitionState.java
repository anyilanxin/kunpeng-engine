...
import static com.anyilanxin.kunpeng.protocol.business.RecordMappingIndex.RECORD_INDEX_14;
...
public enum FormDefinitionState implements CommandValueLifeCycle {
  ...
  FormDefinitionState(final short value, final short processIndex) {
    this.value = value;
  ...
  public short recordIndex() {
    return RECORD_INDEX_14;
  }

  @Override
  public ValueType getValueType() {
    return ValueType.FORM_DEFINITION;
  }
  ...
  public static FormDefinitionState fromValue(final short value) {
    return switch (value) {
      case 0 -> CREATED;
      case 1 -> DELETED;
      default -> CREATED;
