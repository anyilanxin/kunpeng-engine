 ...
 * @since 2026.9.0
 */
public interface IncidentRecordValue extends TenantOwned, DurationValue, RecordValue {
  ...
  ValueType getIncidentRecordValueType();

  ValueLifeCycle getIncidentRecordLifeCycle();
}
