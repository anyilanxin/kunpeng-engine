...
import static com.anyilanxin.kunpeng.protocol.business.RecordMappingIndex.RECORD_INDEX_12;
...
public enum DecisionDefinitionLifeCycle implements CommandValueLifeCycle {
  ...
  DecisionDefinitionLifeCycle(final short value, final short processIndex) {
    this.value = value;
  ...
  public static DecisionDefinitionLifeCycle fromValue(final short value) {
    return switch (value) {
      case 0 -> CREATED;
      case 1 -> DELETED;
      default -> CREATED;
