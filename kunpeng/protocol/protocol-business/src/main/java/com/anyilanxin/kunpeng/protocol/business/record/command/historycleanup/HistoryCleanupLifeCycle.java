 ...
 */
package com.anyilanxin.kunpeng.protocol.business.record.command.historycleanup;

import static com.anyilanxin.kunpeng.protocol.business.RecordMappingIndex.RECORD_INDEX_71;
...
public enum HistoryCleanupLifeCycle implements ValueLifeCycle {
  ...
  HistoryCleanupLifeCycle(final short value, final short processIndex) {
    this.value = value;
  ...
  public static HistoryCleanupLifeCycle fromValue(final short value) {
    return switch (value) {
      case 1 -> CREATE;
      case 2 -> CREATED;
      case 3 -> TRIGGER;
