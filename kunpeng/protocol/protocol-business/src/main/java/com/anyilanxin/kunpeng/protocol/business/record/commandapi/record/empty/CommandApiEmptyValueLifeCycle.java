 ...
 */
package com.anyilanxin.kunpeng.protocol.business.record.commandapi.record.empty;

import static com.anyilanxin.kunpeng.protocol.business.RecordMappingIndex.RECORD_INDEX_55;
 ...
 * @since 2026.9.0
 */
public enum CommandApiEmptyValueLifeCycle implements CommandApiValueLifeCycle {
  RESPONSE((short) 1, NOT_PROCESS_INDEX, RECORD_INDEX_55),
  ;
  private final short value;
  private final short processIndex;
  private final short recordIndex;

  CommandApiEmptyValueLifeCycle(
