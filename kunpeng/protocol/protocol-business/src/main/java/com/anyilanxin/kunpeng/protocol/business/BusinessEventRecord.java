 ...
 * @since 2026.9.0
 */
public interface BusinessEventRecord<T extends RecordValue> extends JsonSerializable {
  /**
  ...
  /**
   * 返回记录的原始值，为本协议各值类型接口（record value 包）的某个实现。
   *
   ...
   * @return 当前记录的一个深拷贝
   */
  default BusinessEventRecord<T> copyOf() {
