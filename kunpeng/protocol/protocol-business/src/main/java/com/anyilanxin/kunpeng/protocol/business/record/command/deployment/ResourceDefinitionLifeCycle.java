...
import static com.anyilanxin.kunpeng.protocol.business.RecordMappingIndex.RECORD_INDEX_76;
...
public enum ResourceDefinitionLifeCycle implements CommandValueLifeCycle {
  ...
  ResourceDefinitionLifeCycle(final short value, final short processIndex) {
    this.value = value;
  ...
  public static ResourceDefinitionLifeCycle fromValue(final short value) {
    return switch (value) {
      case 0 -> CREATED;
      case 1 -> DELETED;
      default -> CREATED;
