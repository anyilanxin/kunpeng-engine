...
import com.anyilanxin.kunpeng.protocol.business.record.commandapi.record.incident.resolve.IncidentResolveRequestRecordValue;
...
public class IncidentResolveRequestRecord extends UnifiedRecordValue<IncidentResolveRequestRecord>
    implements IncidentResolveRequestRecordValue {
  // structpack-ids[IncidentResolveRequestRecord]: 1,2
  ...
  public IncidentResolveRequestRecord() {
    super(2);
    // formatting:off
  ...
  @Override
  public IncidentResolveRequestRecord setIncidentId(final long incidentId) {
  ...
  @Override
  public IncidentResolveRequestRecord setTenantId(final String tenantId) {
    tenantIdProp.setValue(wrapString(tenantId));
    return this;
  }

  @Override
  public IncidentResolveRequestRecord setTenantId(final DirectBuffer tenantId) {
