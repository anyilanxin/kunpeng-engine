...
import com.anyilanxin.kunpeng.protocol.business.record.commandapi.record.usertask.cancel.UserTaskCancelRequestRecordValue;
...
public class UserTaskCancelRequestRecord extends UnifiedRecordValue<UserTaskCancelRequestRecord>
    implements UserTaskCancelRequestRecordValue {
  // structpack-ids[UserTaskCancelRequestRecord]: 1,2,3,4
  ...
  public UserTaskCancelRequestRecord() {
    super(4);
  ...
  public UserTaskCancelRequestRecord setTaskId(final long taskId) {
  ...
  public UserTaskCancelRequestRecord setVariables(final DirectBuffer variables) {
    variablesProperty.setValue(variables);
    return this;
  }

  public UserTaskCancelRequestRecord setVariables(final Map<String, Object> variables) {
  ...
  public UserTaskCancelRequestRecord setLocalVariables(final DirectBuffer localVariables) {
    localVariablesProperty.setValue(localVariables);
    return this;
  }

  public UserTaskCancelRequestRecord setLocalVariables(final Map<String, Object> localVariables) {
  ...
  public UserTaskCancelRequestRecord setTenantId(final DirectBuffer tenantId) {
    tenantIdProp.setValue(tenantId);
    return this;
  }

  public UserTaskCancelRequestRecord setTenantId(final String tenantId) {
    tenantIdProp.setValue(wrapString(tenantId));
    return this;
  }

  @Override
  protected UserTaskCancelRequestRecord newRecord() {
    return new UserTaskCancelRequestRecord();
  }
}
