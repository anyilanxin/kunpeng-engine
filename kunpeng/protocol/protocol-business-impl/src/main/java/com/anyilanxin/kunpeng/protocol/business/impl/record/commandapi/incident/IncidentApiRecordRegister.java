 ...
 */
package com.anyilanxin.kunpeng.protocol.business.impl.record.commandapi.incident;
...
/**
 * 事件（incident）域 API Record 注册器。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public class IncidentApiRecordRegister {
  private IncidentApiRecordRegister() {}

  @SuppressWarnings({"rawtypes", "unchecked"})
  public static void register(final RecordValueMapperRegister valueMapper) {
    valueMapper
        .register(
            CommandApiIncidentValueLifeCycle.RESOLVE_REQUEST, IncidentResolveRequestRecord::new)
        .register(
            CommandApiIncidentValueLifeCycle.RESOLVE_RESPONSE, IncidentResolveResponseRecord::new);
  }
}
