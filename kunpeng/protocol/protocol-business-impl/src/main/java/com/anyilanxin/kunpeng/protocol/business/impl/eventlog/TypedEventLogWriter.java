...
public final class TypedEventLogWriter implements EventLogWriter {
  ...
  public AppendResult tryAppend(
      final WriteContext context, final RecordMetadata metadata, final UnifiedRecordValue value) {
  ...
  private AppendResult record(final RecordMetadata metadata, final AppendResult result) {
    if (registry != null && result instanceof AppendResult.Appended) {
      final String recordType = String.valueOf(metadata.getRecordType());
      ...
      typedCounters
          .computeIfAbsent(
              ...
              key ->
                  registry.counter(
                      "protocol.eventlog.append.count",
                      "recordType",
                      recordType,
                      "valueType",
                      valueType))
