 ...
 */
package com.anyilanxin.kunpeng.protocol.business.impl.record.command.incodent;
...
public class IncidentRecord extends UnifiedRecordValue<IncidentRecord>
  ...
  private final LongProperty processInstanceIdProp = new LongProperty(9, PROCESS_INSTANCE_ID);
  ...
  private final LongProperty taskIdProp = new LongProperty(12, TASK_ID, -1);
  private final LongProperty jobIdProp = new LongProperty(4, "JOB_ID", -1);
  ...
  private final EnumProperty<ValueType> incidentRecordValueTypeProp =
      new EnumProperty<>(5, "INCIDENT_RECORD_VALUE_TYPE", ValueType.class, ValueType.UNKNOW);
  private final ShortProperty incidentRecordLifeCycleProp =
      new ShortProperty(6, "INCIDENT_RECORD_LIFE_CYCLE", (short) -1);
  ...
  public IncidentRecord setIncidentId(final long incidentId) {
  ...
  public IncidentRecord setIncidentType(final IncidentType incidentType) {
  ...
  public IncidentRecord setIncidentMessage(final String incidentMessage) {
    incidentMessageProp.setValue(wrapString(incidentMessage));
    return this;
  }

  public IncidentRecord setIncidentMessage(final DirectBuffer incidentMessage) {
  ...
  public IncidentRecord setProcessDefinitionKey(final String processDefinitionKey) {
    processDefinitionKeyProp.setValue(wrapString(processDefinitionKey));
    return this;
  }

  public IncidentRecord setProcessDefinitionKey(final DirectBuffer processDefinitionKey) {
  ...
  public IncidentRecord setProcessDefinitionId(final long processDefinitionId) {
  ...
  public IncidentRecord setProcessInstanceId(final long processInstanceId) {
  ...
  public IncidentRecord setActivityDefinitionKey(final String activityDefinitionKey) {
    activityDefinitionKeyProp.setValue(wrapString(activityDefinitionKey));
    return this;
  }

  public IncidentRecord setActivityDefinitionKey(final DirectBuffer activityDefinitionKey) {
  ...
  public IncidentRecord setActivityInstanceId(final long activityInstanceId) {
  ...
  public IncidentRecord setTaskId(final long taskId) {
  ...
  public IncidentRecord setJobId(final long jobId) {
  ...
  public IncidentRecord setStartTime(final long startTime) {
  ...
  public IncidentRecord setEndTime(final long endTime) {
  ...
  public IncidentRecord setDuration(final long duration) {
  ...
  public IncidentRecord setIncidentRecordValueType(final ValueType incidentRecordValueType) {
  ...
  public IncidentRecord setIncidentRecordLifeCycle(final ValueLifeCycle incidentRecordLifeCycle) {
    incidentRecordLifeCycleProp.setValue(incidentRecordLifeCycle.value());
    return this;
  }

  @Override
  protected IncidentRecord newRecord() {
