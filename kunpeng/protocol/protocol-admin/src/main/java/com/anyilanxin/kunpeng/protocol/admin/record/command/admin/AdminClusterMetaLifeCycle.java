...
import static com.anyilanxin.kunpeng.protocol.admin.AdminRecordMappingIndex.RECORD_INDEX_2;
...
public enum AdminClusterMetaLifeCycle implements CommandValueLifeCycle {
  ...
  CREATING((short) 1, PROCESS_INDEX_18),

  CREATED((short) 2, PROCESS_INDEX_19),

  UPDATING((short) 3, PROCESS_INDEX_20),

  UPDATED((short) 4, PROCESS_INDEX_21),
  ;

  private final short value;
  private final short processIndex;

  AdminClusterMetaLifeCycle(final short value, final short processIndex) {
    this.value = value;
  ...
  public static AdminClusterMetaLifeCycle fromValue(final short value) {
    return switch (value) {
      case 1 -> CREATING;
      case 2 -> CREATED;
      case 3 -> UPDATING;
