 ...
 */
package com.anyilanxin.kunpeng.protocol.admin.record.commandapi.business.dispatch;
...
/**
 * 业务面调度变更响应 Record 值接口。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public interface BusinessChangeResponseRecordValue extends RecordValue, ResponseRecordValue {
