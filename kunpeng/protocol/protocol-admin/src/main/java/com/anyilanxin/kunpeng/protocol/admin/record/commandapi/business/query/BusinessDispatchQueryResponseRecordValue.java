 ...
 */
package com.anyilanxin.kunpeng.protocol.admin.record.commandapi.business.query;
...
/**
 * 业务面调度查询响应 Record 值接口。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public interface BusinessDispatchQueryResponseRecordValue extends RecordValue, ResponseRecordValue {
  BusinessDispatchPlanRecordValue getDispatchPlan();

  BusinessClusterMetaRecordValue getClusterMeta();
}
