...
import static com.anyilanxin.kunpeng.bpm.model.dmn.DecisionTableOrientation.CrossTable;
import static com.anyilanxin.kunpeng.bpm.model.dmn.DecisionTableOrientation.Rule_as_Column;
import static com.anyilanxin.kunpeng.bpm.model.dmn.DecisionTableOrientation.Rule_as_Row;
import static com.anyilanxin.kunpeng.bpm.model.dmn.HitPolicy.ANY;
import static com.anyilanxin.kunpeng.bpm.model.dmn.HitPolicy.COLLECT;
import static com.anyilanxin.kunpeng.bpm.model.dmn.HitPolicy.FIRST;
import static com.anyilanxin.kunpeng.bpm.model.dmn.HitPolicy.OUTPUT_ORDER;
import static com.anyilanxin.kunpeng.bpm.model.dmn.HitPolicy.PRIORITY;
import static com.anyilanxin.kunpeng.bpm.model.dmn.HitPolicy.RULE_ORDER;
import static com.anyilanxin.kunpeng.bpm.model.dmn.HitPolicy.UNIQUE;
...
public class ReadWriteTest extends DmnModelTest {
  ...
  public void shouldReadInputData() {
    ...
    final Collection<InputData> inputDataCollection = modelInstance.getModelElementsByType(InputData.class);

    assertThat(inputDataCollection).hasSize(2);
    assertThat(inputDataCollection).extracting("class").contains(InputDataImpl.class);

    final InputData inputData = modelInstance.getModelElementById("customerStatusIn");
