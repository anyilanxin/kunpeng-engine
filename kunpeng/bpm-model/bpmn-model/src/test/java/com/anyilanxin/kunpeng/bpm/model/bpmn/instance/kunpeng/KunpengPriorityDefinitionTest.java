...
public class KunpengPriorityDefinitionTest extends BpmnModelElementInstanceTest {
    ...
    public Collection<AttributeAssumption> getAttributesAssumptions() {
        return Arrays.asList(
                new AttributeAssumption(
                  BpmnModelConstants.KUNPENG_NS,
                        "priority",
                        false,
                        false,
                  KunpengPriorityDefinition.DEFAULT_LITERAL_PRIORITY));
    }
}
