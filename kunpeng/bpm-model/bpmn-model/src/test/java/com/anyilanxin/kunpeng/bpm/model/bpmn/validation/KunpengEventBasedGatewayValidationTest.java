...
public class KunpengEventBasedGatewayValidationTest extends AbstractKunpengValidationTest {
        ...
        return new Object[][]{
                ...
                },
                {
                        Bpmn.createExecutableProcess("process")
                                ...
                                .moveToLastGateway()
                                .intermediateCatchEvent(
                                  "catch", c -> c.message(m -> m.name("msg").kunpengCorrelationKeyExpression("foo")))
                                .done(),
                        singletonList(
                                expect(
                ...
                },
                {
                        Bpmn.createExecutableProcess("process")
                                ...
                                .eventBasedGateway()
                                .intermediateCatchEvent(
                                  "catch-1", c -> c.message(m -> m.name("msg").kunpengCorrelationKeyExpression("foo")))
                                .moveToLastGateway()
                                .intermediateCatchEvent(
                                  "catch-2", c -> c.message(m -> m.name("msg").kunpengCorrelationKeyExpression("foo")))
                                .done(),
                        singletonList(
                                expect(
                                        EventBasedGateway.class,
                ...
                },
                {
                        Bpmn.createExecutableProcess("process")
                                ...
                                .eventBasedGateway()
                                .intermediateCatchEvent(
                                  "catch-1", c -> c.message(m -> m.name(null).kunpengCorrelationKeyExpression("foo")))
                                .moveToLastGateway()
                                .intermediateCatchEvent(
                                  "catch-2", c -> c.message(m -> m.name("msg").kunpengCorrelationKeyExpression(null)))
                                .done(),
                        Arrays.asList(
                ...
                },
                {
                        Bpmn.createExecutableProcess("process")
                                ...
                                .eventBasedGateway()
                                .receiveTask()
                          .message(m -> m.name("this").kunpengCorrelationKeyExpression("foo"))
                                .moveToLastGateway()
                                .receiveTask()
                          .message(m -> m.name("that").kunpengCorrelationKeyExpression("foo"))
                                .done(),
                        singletonList(
                                expect(
                                        EventBasedGateway.class,
