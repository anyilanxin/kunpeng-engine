...
public class KunpengIoMappingTest extends BpmnModelElementInstanceTest {
    ...
    public Collection<ChildElementAssumption> getChildElementAssumptions() {
        return Arrays.asList(
          new ChildElementAssumption(BpmnModelConstants.KUNPENG_NS, KunpengInput.class),
          new ChildElementAssumption(BpmnModelConstants.KUNPENG_NS, KunpengOutput.class));
    }
