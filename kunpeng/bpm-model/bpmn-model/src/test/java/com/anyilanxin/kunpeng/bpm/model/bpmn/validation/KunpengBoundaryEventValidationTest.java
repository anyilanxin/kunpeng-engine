...
public class KunpengBoundaryEventValidationTest extends AbstractKunpengValidationTest {
    ...
    public static Object[][] parameters() {
        return new Object[][]{
                ...
                },
                {
                        Bpmn.createExecutableProcess("process")
                                .startEvent("start")
                          .serviceTask("task1", b -> b.kunpengJobType("type"))
                                .boundaryEvent("boundary")
                                .cancelActivity(true)
                                .timerWithDuration("PT0.5S")
                                .moveToActivity("task1")
                          .serviceTask("task2", b -> b.kunpengJobType("type"))
