...
public class KunpengValidationTest extends AbstractKunpengValidationTest {
    ...
    public static Object[][] parameters() {
        return new Object[][]{
                ...
                },
                {
                        Bpmn.createExecutableProcess("process")
                                .startEvent()
                          .serviceTask("task", b -> b.kunpengJobType("type"))
                                .boundaryEvent("msg1")
                          .message(m -> m.name("message").kunpengCorrelationKeyExpression("id"))
                                .endEvent()
                                .moveToActivity("task")
                                .boundaryEvent("msg2")
                          .message(m -> m.name("message").kunpengCorrelationKeyExpression("orderId"))
                                .endEvent()
                                .done(),
                        singletonList(
                                expect(
