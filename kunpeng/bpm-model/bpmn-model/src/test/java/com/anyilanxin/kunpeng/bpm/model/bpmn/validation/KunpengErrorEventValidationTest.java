...
import com.anyilanxin.kunpeng.bpm.model.bpmn.builder.AbstractBoundaryEventBuilder;
...
public class KunpengErrorEventValidationTest extends AbstractKunpengValidationTest {
        ...
        return new Object[][]{
                {
                        Bpmn.createExecutableProcess("process")
                                .startEvent()
                          .serviceTask("task", t -> t.kunpengJobType("type"))
