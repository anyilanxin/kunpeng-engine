 ...
 */
package com.anyilanxin.kunpeng.bpm.model.bpmn.instance.zeebe;
...
public class ZeebeTaskListenerTest extends BpmnModelElementInstanceTest {
  ...
  public void shouldThrowExceptionForInvalidTaskListenerEventType() {
    ...
    assertThatThrownBy(() -> first.get().getEventType())
        ...
        .hasMessage(
            "No enum constant com.anyilanxin.kunpeng.bpm.model.bpmn.instance.zeebe.ZeebeTaskListenerEventType.rejection");
  }
}
