...
public class KunpengLinkEventValidationTest {
        ...
        final BpmnModelInstance process =
                Bpmn.readModelFromStream(
                        ReflectUtil.getResourceAsStream(
                          "com/anyilanxin/kunpeng/bpm/model/bpmn/validation/LinkEventTest.testValidEventLink.bpmn"));
    ...
    void testEventLinkMultipleSources() {
        ...
        final BpmnModelInstance process =
                Bpmn.readModelFromStream(
                        ReflectUtil.getResourceAsStream(
                          "com/anyilanxin/kunpeng/bpm/model/bpmn/validation/LinkEventTest.testEventLinkMultipleSources.bpmn"));
    ...
    void testInvalidEventLinkMultipleTarget() {
        ...
        final BpmnModelInstance process =
                Bpmn.readModelFromStream(
                        ReflectUtil.getResourceAsStream(
                          "com/anyilanxin/kunpeng/bpm/model/bpmn/validation/LinkEventTest.testInvalidEventLinkMultipleTarget.bpmn"));
    ...
    void testCatchLinkEventAfterEventBasedGatewayNotAllowed() {
        ...
        final BpmnModelInstance process =
                Bpmn.readModelFromStream(
                        ReflectUtil.getResourceAsStream(
                          "com/anyilanxin/kunpeng/bpm/model/bpmn/validation/LinkEventTest.testCatchLinkEventAfterEventBasedGatewayNotAllowed.bpmn"));
