...
public class KunpengTaskScheduleTest extends BpmnModelElementInstanceTest {
    ...
    public Collection<AttributeAssumption> getAttributesAssumptions() {
        return Arrays.asList(
          new AttributeAssumption(BpmnModelConstants.KUNPENG_NS, "dueDate", false, false),
          new AttributeAssumption(BpmnModelConstants.KUNPENG_NS, "followUpDate", false, false));
    }
}
