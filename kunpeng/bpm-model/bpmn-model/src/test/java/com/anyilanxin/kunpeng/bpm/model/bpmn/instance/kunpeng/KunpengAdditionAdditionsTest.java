...
public class KunpengAdditionAdditionsTest extends BpmnModelElementInstanceTest {
    ...
    public Collection<ChildElementAssumption> getChildElementAssumptions() {
        return Arrays.asList(
                new ChildElementAssumption(BpmnModelConstants.KUNPENG_NS, KunpengAddition.class));
    }
