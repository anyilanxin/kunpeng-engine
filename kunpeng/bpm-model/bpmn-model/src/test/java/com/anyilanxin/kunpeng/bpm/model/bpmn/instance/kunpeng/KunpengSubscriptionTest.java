...
public class KunpengSubscriptionTest extends BpmnModelElementInstanceTest {
    ...
    public Collection<AttributeAssumption> getAttributesAssumptions() {
        return Arrays.asList(
          new AttributeAssumption(BpmnModelConstants.KUNPENG_NS, "correlationKey", false, true));
    }
}
