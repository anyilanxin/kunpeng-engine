...
import com.anyilanxin.kunpeng.bpm.model.bpmn.builder.EndEventBuilder;
import com.anyilanxin.kunpeng.bpm.model.bpmn.builder.StartEventBuilder;
import com.anyilanxin.kunpeng.bpm.model.bpmn.instance.CancelEventDefinition;
...
class KunpengEndEventValidationTest {
  ...
  private static Stream<BpmnElementBuilder> supportedEndEventTypes() {
    return Stream.of(
        ...
        BpmnElementBuilder.of(
            "message (job worker)",
            builder ->
              builder.endEvent(END_EVENT_ID).message("message-name").kunpengJobType("job-type")),
        BpmnElementBuilder.of(
            "message",
            builder ->
                builder
                    .endEvent(END_EVENT_ID)
                  .message(b -> b.name("message-name").kunpengCorrelationKey("correlationKey"))),
