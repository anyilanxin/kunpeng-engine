...
public final class BusinessRuleTaskValidator implements ModelElementValidator<BusinessRuleTask> {
    ...
    if (!hasExactlyOneExtension(element)) {
      validationResultCollector.addError(
          ...
          String.format(
              ...
              KunpengConstants.ELEMENT_CALLED_DECISION, KunpengConstants.ELEMENT_TASK_DEFINITION));
    }
  }
  ...
  private boolean hasExactlyOneExtension(final BusinessRuleTask element) {
    ...
    final Collection<KunpengCalledDecision> calledDecisionExtensions =
        extensionElements.getChildElementsByType(KunpengCalledDecision.class);
