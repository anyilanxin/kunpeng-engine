...
public class KunpengExecutionListenersImpl extends BpmnModelElementInstanceImpl
    implements KunpengExecutionListeners {

  protected static ChildElementCollection<KunpengExecutionListener> executionListenersCollection;

  public KunpengExecutionListenersImpl(final ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  @Override
  public Collection<KunpengExecutionListener> getExecutionListeners() {
  ...
  public static void registerType(final ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(
                KunpengExecutionListeners.class, KunpengConstants.ELEMENT_EXECUTION_LISTENERS)
            .namespaceUri(BpmnModelConstants.KUNPENG_NS)
            .instanceProvider(KunpengExecutionListenersImpl::new);

    executionListenersCollection =
        typeBuilder.sequence().elementCollection(KunpengExecutionListener.class).build();
