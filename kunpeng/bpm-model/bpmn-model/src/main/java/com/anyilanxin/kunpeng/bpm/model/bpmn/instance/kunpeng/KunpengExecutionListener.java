...
public interface KunpengExecutionListener extends BpmnModelElementInstance {

  String DEFAULT_RETRIES = "3";

  KunpengExecutionListenerEventType getEventType();

  void setEventType(KunpengExecutionListenerEventType eventType);
