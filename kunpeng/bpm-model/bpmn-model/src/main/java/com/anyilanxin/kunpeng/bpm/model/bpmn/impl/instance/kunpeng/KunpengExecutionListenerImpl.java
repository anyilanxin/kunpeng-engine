...
public class KunpengExecutionListenerImpl extends BpmnModelElementInstanceImpl
    implements KunpengExecutionListener {

  protected static Attribute<KunpengExecutionListenerEventType> eventTypeAttribute;
  protected static Attribute<String> typeAttribute;
  protected static Attribute<String> retriesAttribute;

  public KunpengExecutionListenerImpl(final ModelTypeInstanceContext instanceContext) {
  ...
  @Override
  public void setEventType(final KunpengExecutionListenerEventType eventType) {
  ...
  public static void registerType(final ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(KunpengExecutionListener.class, KunpengConstants.ELEMENT_EXECUTION_LISTENER)
            .namespaceUri(BpmnModelConstants.KUNPENG_NS)
            .instanceProvider(KunpengExecutionListenerImpl::new);

    eventTypeAttribute =
        typeBuilder
            .enumAttribute(
                KunpengConstants.ATTRIBUTE_EVENT_TYPE, KunpengExecutionListenerEventType.class)
    ...
    retriesAttribute =
        typeBuilder
            ...
            .defaultValue(KunpengExecutionListener.DEFAULT_RETRIES)
            .namespace(BpmnModelConstants.KUNPENG_NS)
            .build();
