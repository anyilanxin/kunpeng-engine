...
public class KunpengAdditionImpl extends BpmnModelElementInstanceImpl implements KunpengAddition {

  private static Attribute<String> keyAttribute;
  private static Attribute<String> valueAttribute;

  public KunpengAdditionImpl(final ModelTypeInstanceContext instanceContext) {
  ...
  public static void registerType(final ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(KunpengAddition.class, KunpengConstants.ELEMENT_ADDITION)
            .namespaceUri(BpmnModelConstants.KUNPENG_NS)
            .instanceProvider(KunpengAdditionImpl::new);

    keyAttribute =
        typeBuilder
            .stringAttribute(KunpengConstants.ATTRIBUTE_KEY)
