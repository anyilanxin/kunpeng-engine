...
public class KunpengLinkedResourcesImpl extends BpmnModelElementInstanceImpl
    implements KunpengLinkedResources {

  protected static ChildElementCollection<KunpengLinkedResource> linkedResources;

  public KunpengLinkedResourcesImpl(final ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  @Override
  public Collection<KunpengLinkedResource> getLinkedResources() {
  ...
  public static void registerType(final ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(KunpengLinkedResources.class, KunpengConstants.ELEMENT_LINKED_RESOURCES)
            .namespaceUri(BpmnModelConstants.KUNPENG_NS)
            .instanceProvider(KunpengLinkedResourcesImpl::new);

    linkedResources = typeBuilder.sequence().elementCollection(KunpengLinkedResource.class).build();
