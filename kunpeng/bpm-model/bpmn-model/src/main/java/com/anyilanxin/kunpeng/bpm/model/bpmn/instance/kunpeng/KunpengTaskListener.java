...
public interface KunpengTaskListener extends BpmnModelElementInstance {

  String DEFAULT_RETRIES = "3";

  KunpengTaskListenerEventType getEventType();

  void setEventType(KunpengTaskListenerEventType eventType);
