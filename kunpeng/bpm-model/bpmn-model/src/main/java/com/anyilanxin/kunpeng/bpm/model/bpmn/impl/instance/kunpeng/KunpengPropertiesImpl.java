...
public class KunpengPropertiesImpl extends BpmnModelElementInstanceImpl
    implements KunpengProperties {

  protected static ChildElementCollection<KunpengProperty> propertiesCollection;

  public KunpengPropertiesImpl(final ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  @Override
  public Collection<KunpengProperty> getProperties() {
  ...
  public static void registerType(final ModelBuilder modelBuilder) {
    final ModelElementTypeBuilder typeBuilder =
        modelBuilder
            .defineType(KunpengProperties.class, KunpengConstants.ELEMENT_PROPERTIES)
            .namespaceUri(BpmnModelConstants.KUNPENG_NS)
            .instanceProvider(KunpengPropertiesImpl::new);

    propertiesCollection = typeBuilder.sequence().elementCollection(KunpengProperty.class).build();
