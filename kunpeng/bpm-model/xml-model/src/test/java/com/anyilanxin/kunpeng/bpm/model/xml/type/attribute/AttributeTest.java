...
import com.anyilanxin.kunpeng.bpm.model.xml.testmodel.instance.Animal;
import com.anyilanxin.kunpeng.bpm.model.xml.testmodel.instance.AnimalTest;
import com.anyilanxin.kunpeng.bpm.model.xml.testmodel.instance.Animals;
import com.anyilanxin.kunpeng.bpm.model.xml.testmodel.instance.Bird;
...
public class AttributeTest extends TestModelTest {
  ...
  public AttributeTest(final String testName, final ModelInstance testModelInstance, final AbstractModelParser modelParser) {
  ...
  public void copyModelInstance() {
    ...
    final ModelElementType animalType = modelInstance.getModel().getType(Animal.class);
  ...
  public void testSetAttributeValue() {
    final String identifier = "new-" + tweety.getId();
