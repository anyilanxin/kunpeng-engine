 ...
 */
package com.anyilanxin.kunpeng.bpm.model.xml.instance;
...
import com.anyilanxin.kunpeng.bpm.model.xml.testmodel.instance.Description;
...
public class DomTest extends TestModelTest {
  ...
  public DomTest(final String testName, final ModelInstance testModelInstance, final AbstractModelParser modelParser) {
  ...
  public void testRegisterNamespaces() {
    ...
    final String prefix = document.registerNamespace(UNKNOWN_NS);
