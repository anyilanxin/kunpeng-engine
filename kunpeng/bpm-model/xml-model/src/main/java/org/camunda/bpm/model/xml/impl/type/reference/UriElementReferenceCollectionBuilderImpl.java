...
public class UriElementReferenceCollectionBuilderImpl<
  ...
  public UriElementReferenceCollectionBuilderImpl(
    ...
    this.elementReferenceCollectionImpl =
        new UriElementReferenceCollectionImpl<Target, Source>(collection);
  }
}
