...
public class AdminChangeReplicationRequest
  ...
  public AdminChangeReplicationRequest() {
    super(
        AdminValueType.ADMIN_DISPATCH_API,
        AdminDispatchApiValueLifeCycle.CHANGE_REPLICATION_REQUEST,
        new AdminChangeReplicationRequestRecord());
  }

  public AdminChangeReplicationRequest expectReplicationFactor(final int expectReplicationFactor) {
    getValue().setExpectReplicationFactor(expectReplicationFactor);
    return this;
  }

  public AdminChangeReplicationRequest apply(final boolean apply) {
