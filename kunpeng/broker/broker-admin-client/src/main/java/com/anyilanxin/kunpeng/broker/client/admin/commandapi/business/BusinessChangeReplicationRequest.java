 ...
 * @since
 */
public class BusinessChangeReplicationRequest
    extends CommandApiBrokerRequest<BusinessChangeReplicationRequestRecord> {

  public BusinessChangeReplicationRequest() {
    super(
        AdminValueType.BUSINESS_DISPATCH_API,
        BusinessDispatchApiValueLifeCycle.CHANGE_REPLICATION_REQUEST,
        new BusinessChangeReplicationRequestRecord());
  }

  public BusinessChangeReplicationRequest expectReplicationFactor(
      final int expectReplicationFactor) {
    getValue().setExpectReplicationFactor(expectReplicationFactor);
    return this;
  }

  public BusinessChangeReplicationRequest apply(final boolean apply) {
    getValue().setApplyPlan(apply);
    return this;
  }
}
