...
public class BusinessChangePartitionRequest
  ...
  public BusinessChangePartitionRequest() {
    super(
        ...
        new BusinessChangePartitionRequestRecord());
  }

  public BusinessChangePartitionRequest expectPartitionsCount(final int expectPartitionsCount) {
    getValue().setExpectPartitionsCount(expectPartitionsCount);
    return this;
  }

  public BusinessChangePartitionRequest apply(final boolean apply) {
