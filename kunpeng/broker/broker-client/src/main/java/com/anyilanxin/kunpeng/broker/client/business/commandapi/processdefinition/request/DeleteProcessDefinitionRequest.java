...
public class DeleteProcessDefinitionRequest
    extends ProcessDefinitionAbstractRequest<ProcessDefinitionDeleteRequestRecord> {
  public DeleteProcessDefinitionRequest() {
    super(
        CommandApiProcessDefinitionValueLifeCycle.DELETE_REQUEST,
        new ProcessDefinitionDeleteRequestRecord());
  }
}
