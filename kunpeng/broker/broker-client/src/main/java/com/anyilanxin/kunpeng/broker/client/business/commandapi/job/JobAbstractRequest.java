...
/**
 * job 类请求抽象基类：公共请求字段与序列化逻辑。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public abstract class JobAbstractRequest<VALUE extends RequestRecordValue>
    extends CommandApiBrokerRequest<VALUE> {

  public JobAbstractRequest(final CommandApiJobValueLifeCycle lifeCycle, final VALUE value) {
    super(ValueType.JOB_API, lifeCycle, value);
  }
}
