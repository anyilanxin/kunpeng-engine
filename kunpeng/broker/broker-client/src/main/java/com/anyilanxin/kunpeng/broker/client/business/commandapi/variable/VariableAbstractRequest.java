 ...
 */
package com.anyilanxin.kunpeng.broker.client.business.commandapi.variable;
...
/**
 * 变量类请求抽象基类：公共请求字段与序列化逻辑。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public abstract class VariableAbstractRequest<VALUE extends RequestRecordValue>
    extends CommandApiBrokerRequest<VALUE> {

  public VariableAbstractRequest(
      final CommandApiVariableValueLifeCycle lifeCycle, final VALUE value) {
    super(ValueType.VARIABLE_API, lifeCycle, value);
  }
}
