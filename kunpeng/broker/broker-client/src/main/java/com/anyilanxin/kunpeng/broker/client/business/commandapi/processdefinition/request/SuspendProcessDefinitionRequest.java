 ...
 * @since 2026.9.0
 */
public class SuspendProcessDefinitionRequest
    extends ProcessDefinitionAbstractRequest<ProcessDefinitionSuspendRequestRecord> {
  public SuspendProcessDefinitionRequest() {
    super(
