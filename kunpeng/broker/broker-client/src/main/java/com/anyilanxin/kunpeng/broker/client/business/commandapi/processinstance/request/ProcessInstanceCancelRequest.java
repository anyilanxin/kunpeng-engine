 ...
 * @since 2026.9.0
 */
public class ProcessInstanceCancelRequest
    extends ProcessInstanceAbstractRequest<ProcessInstanceCancelRequestRecord> {
  public ProcessInstanceCancelRequest(final long processInstanceId) {
    super(
        CommandApiProcessInstanceValueLifeCycle.CANCEL_REQUEST,
        new ProcessInstanceCancelRequestRecord());
