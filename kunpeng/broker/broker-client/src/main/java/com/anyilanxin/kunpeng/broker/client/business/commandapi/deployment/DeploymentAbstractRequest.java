 ...
 */
package com.anyilanxin.kunpeng.broker.client.business.commandapi.deployment;
...
/**
 * 部署类请求抽象基类：公共请求字段与序列化逻辑。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public abstract class DeploymentAbstractRequest<VALUE extends RequestRecordValue>
    extends CommandApiBrokerRequest<VALUE> {

  public DeploymentAbstractRequest(
      final CommandApiDeploymentValueLifeCycle lifeCycle, final VALUE value) {
    super(ValueType.DEPLOYMENT_API, lifeCycle, value);
  }
}
