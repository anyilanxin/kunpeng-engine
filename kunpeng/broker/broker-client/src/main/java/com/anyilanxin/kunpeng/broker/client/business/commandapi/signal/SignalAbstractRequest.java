 ...
 */
package com.anyilanxin.kunpeng.broker.client.business.commandapi.signal;
...
/**
 * 信号类请求抽象基类：公共请求字段与序列化逻辑。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public abstract class SignalAbstractRequest<VALUE extends RequestRecordValue>
    extends CommandApiBrokerRequest<VALUE> {

  public SignalAbstractRequest(final CommandApiSignalValueLifeCycle lifeCycle, final VALUE value) {
    super(ValueType.SIGNAL_SUBSCRIPTION_API, lifeCycle, value);
  }
}
