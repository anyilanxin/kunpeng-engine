 ...
 * @since 2026.9.0
 */
public class UserTaskCancelRequest extends UserTaskAbstractRequest<UserTaskCancelRequestRecord> {

  public UserTaskCancelRequest(final long taskId) {
    super(CommandApiUserTaskValueLifeCycle.CANCEL_REQUEST, new UserTaskCancelRequestRecord());
