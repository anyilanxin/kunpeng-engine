 ...
 * @since 2026.9.0
 */
public final class BusinessRaftAppendListenerAdapter implements LogAppender.AppendListener {

  private static final Logger LOG =
      LoggerFactory.getLogger(BusinessRaftAppendListenerAdapter.class);

  private final long lastPosition;
  private final EventStore.AppendListener delegate;

  public BusinessRaftAppendListenerAdapter(
