 ...
 */
package com.anyilanxin.kunpeng.broker.admin;

import com.anyilanxin.kunpeng.broker.admin.raft.AdminRaftClientService;
...
public interface ClusterAdmin {
  ...
  AdminRaftClientService getAdminRaftClientService();

  BusinessRaftClientService getBusinessRaftClientService();
}
