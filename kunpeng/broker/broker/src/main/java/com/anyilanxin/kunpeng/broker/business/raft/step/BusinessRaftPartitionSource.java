 ...
 * @since 2026.9.0
 */
public class BusinessRaftPartitionSource implements RaftPartitionSource, RaftBusinessMetaListener {
  private final IntHashSet agentSourceIds = new IntHashSet();
  private int sourceId = 0;
  private final AtomicBoolean enable = new AtomicBoolean(false);
  private final Supplier<PartitionId> partitionId;

  public BusinessRaftPartitionSource(final Supplier<PartitionId> partitionId) {
  ...
  public void onCompleted(
    ...
    agentSourceIds.addAll(sourceMeta.agentSourceIds());
    enable.set(true);
  }
