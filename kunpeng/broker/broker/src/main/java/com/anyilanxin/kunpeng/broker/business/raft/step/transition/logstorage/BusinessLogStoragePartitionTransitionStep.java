 ...
 */
package com.anyilanxin.kunpeng.broker.business.raft.step.transition.logstorage;
 ...
 * @since 2026.9.0
 */
public final class BusinessLogStoragePartitionTransitionStep
  ...
  public String getName() {
    return "Business Log Storage Partition Transition";
  }
  ...
  private ActorFuture<Void> buildLogStorage(
      final BusinessTransitionContent context, final long currentTerm, final boolean isLeader) {
    final ActorFuture<Void> future = context.getConcurrencyControl().createFuture();
    context
        .getConcurrencyControl()
        .run(
  ...
  private Either<Exception, BusinessRaftEventStore> buildEventStore(
      final BusinessTransitionContent context, final long targetTerm, final boolean isLeader) {
  ...
  private Either<Exception, BusinessRaftEventStore> createReadOnlyStorage(
  ...
  private Either<Exception, BusinessRaftEventStore> checkAndCreateEventStore(
      final BusinessTransitionContent context,
      final RaftPartitionServer server,
