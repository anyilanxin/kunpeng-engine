 ...
 * @author zxuanhong
 */
public final class AdminBusinessMetaListenerStep
    extends RaftBusinessMetaListenerStep<AdminPartitionStartupContext> {

  public AdminBusinessMetaListenerStep(
      final List<RaftBusinessMetaListener> raftBusinessMetaListeners) {
    super(raftBusinessMetaListeners);
  }

  @Override
  public String getName() {
    return "Admin Business Meta Listener Step";
  }
}
