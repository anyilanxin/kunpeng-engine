 ...
 */
package com.anyilanxin.kunpeng.cluster.manager.business.raft.step.transition.logstream;
...
public final class BusinessLogStreamPartitionTransitionStep
    implements TransitionStep<BusinessTransitionContent> {

  private static final Logger LOG =
      LoggerFactory.getLogger(BusinessLogStreamPartitionTransitionStep.class);
  private final Supplier<EventLogBuilder> builderSupplier;

  public BusinessLogStreamPartitionTransitionStep() {
    this(EventLog::builder);
  }

  BusinessLogStreamPartitionTransitionStep(final Supplier<EventLogBuilder> builderSupplier) {
    this.builderSupplier = builderSupplier;
  }

  @Override
  public String getName() {
    return "Business Log Stream Partition Transition";
  }
  ...
  private ActorFuture<Void> buildEventLog(final BusinessTransitionContent context) {
    final ActorFuture<Void> future = context.getConcurrencyControl().createFuture();
