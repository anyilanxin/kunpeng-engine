 ...
 * @author zxuanhong
 */
public final class BusinessFailureListenerStep
    extends RaftFailureListenerStep<BusinessPartitionStartupContext> {

  public BusinessFailureListenerStep(final List<FailureListener> failureListeners) {
    super(failureListeners);
  }

  @Override
  public String getName() {
    return "Business Failure Listener Step";
  }
}
