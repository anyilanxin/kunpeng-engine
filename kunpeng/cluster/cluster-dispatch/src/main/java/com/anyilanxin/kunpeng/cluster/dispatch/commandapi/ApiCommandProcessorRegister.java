 ...
 */
package com.anyilanxin.kunpeng.cluster.dispatch.commandapi;

import com.anyilanxin.kunpeng.cluster.dispatch.LogEventProcessors;
import com.anyilanxin.kunpeng.cluster.dispatch.LogEventWriter;
import com.anyilanxin.kunpeng.cluster.dispatch.commandapi.admin.AdminApiProcessorRegister;
...
public final class ApiCommandProcessorRegister {
  ...
  public static void registerRepository(
    ...
    AdminApiProcessorRegister.registerRepository(processors, writer);
    BusinessApiProcessorRegister.registerRepository(processors, writer);
  }
}
