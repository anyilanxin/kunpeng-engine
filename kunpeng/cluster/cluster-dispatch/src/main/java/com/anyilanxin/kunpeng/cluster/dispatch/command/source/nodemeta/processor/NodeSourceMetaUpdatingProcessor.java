 ...
 */
package com.anyilanxin.kunpeng.cluster.dispatch.command.source.nodemeta.processor;
...
/**
 * 节点 source 元数据更新命令处理器。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public class NodeSourceMetaUpdatingProcessor extends AbstractNodeSourceMetaProcessor {
  protected final LogEventWriter writer;

  public NodeSourceMetaUpdatingProcessor(final LogEventWriter writer) {
    super(writer);
    this.writer = writer;
  }
  ...
  public void processRecord(final AdminLogRecord<NodeSourceMetaRecord> record) {
    ...
    writer.addEvent(-1, NodeSourceMetaLifeCycle.UPDATED, record.getRequestId(), value);
  }

  @Override
  public NodeSourceMetaLifeCycle valueLifeCycle() {
    return NodeSourceMetaLifeCycle.UPDATING;
  }
}
