 ...
 * @since
 */
public class BusinessDispatchClusterBalanceProcessor extends AbstractBusinessDispatchProcessor {
  ...
  public BusinessDispatchClusterBalanceProcessor(final LogEventWriter writer) {
    super(writer);
    this.writer = writer;
  ...
  public void processRecord(final LogRecord<BusinessDispatchPlanRecord> record) {
    ...
    value.setOldReplicationFactor(oldClusterMeta.getReplicationFactor());
    value.setExpectReplicationFactor(oldClusterMeta.getReplicationFactor());
    value.setOldPartitionsCount(oldClusterMeta.getCurrentPartitionCount());
    value.setExpectPartitionsCount(oldClusterMeta.getCurrentPartitionCount());
    value.setOldMeta(oldClusterMeta.getMetaRecord());
    writer.addCommand(
  ...
  public BusinessDispatchPlanLifeCycle valueLifeCycle() {
    return BusinessDispatchPlanLifeCycle.CLUSTER_BALANCE;
  }
}
