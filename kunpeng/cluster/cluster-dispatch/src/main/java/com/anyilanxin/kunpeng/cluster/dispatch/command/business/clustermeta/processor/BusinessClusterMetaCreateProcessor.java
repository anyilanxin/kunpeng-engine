 ...
 * @since
 */
public class BusinessClusterMetaCreateProcessor extends AbstractBusinessClusterMetaProcessor {
  protected final LogEventWriter writer;

  public BusinessClusterMetaCreateProcessor(final LogEventWriter writer) {
    super(writer);
    this.writer = writer;
  }
  ...
  public void processRecord(final LogRecord<BusinessClusterMetaRecord> record) {
    ...
    writer.addEvent(
        record.getKey(), BusinessClusterMetaLifeCycle.CREATED, record.getRequestId(), value);
  }

  @Override
  public BusinessClusterMetaLifeCycle valueLifeCycle() {
    return BusinessClusterMetaLifeCycle.CREATING;
  }
}
