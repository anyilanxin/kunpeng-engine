...
/**
 * 分区 source 治理命令处理器抽象基类。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public abstract class AbstractPartitionSourceProcessor
    implements LogEventProcessorSingleState<PartitionSourceRecord> {
  protected final LogEventWriter writer;

  public AbstractPartitionSourceProcessor(final LogEventWriter writer) {
    this.writer = writer;
  }
  ...
  @Override
  public abstract PartitionSourceLifeCycle valueLifeCycle();
}
