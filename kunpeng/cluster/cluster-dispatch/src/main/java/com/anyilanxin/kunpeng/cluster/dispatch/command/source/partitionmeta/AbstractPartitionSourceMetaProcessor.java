...
/**
 * 分区 source 元数据命令处理器抽象基类。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public abstract class AbstractPartitionSourceMetaProcessor
    implements LogEventProcessorSingleState<PartitionSourceMetaRecord> {
  protected final LogEventWriter writer;

  public AbstractPartitionSourceMetaProcessor(final LogEventWriter writer) {
    this.writer = writer;
  }
  ...
  @Override
  public abstract PartitionSourceMetaLifeCycle valueLifeCycle();
}
