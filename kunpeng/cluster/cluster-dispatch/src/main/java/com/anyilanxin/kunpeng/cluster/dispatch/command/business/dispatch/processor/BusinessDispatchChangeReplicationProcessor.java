 ...
 * @since
 */
public class BusinessDispatchChangeReplicationProcessor extends AbstractBusinessDispatchProcessor {
  ...
  public BusinessDispatchChangeReplicationProcessor(final LogEventWriter writer) {
    super(writer);
    this.writer = writer;
  ...
  public BusinessDispatchPlanLifeCycle valueLifeCycle() {
    return BusinessDispatchPlanLifeCycle.CHANGE_REPLICATION;
  }
}
