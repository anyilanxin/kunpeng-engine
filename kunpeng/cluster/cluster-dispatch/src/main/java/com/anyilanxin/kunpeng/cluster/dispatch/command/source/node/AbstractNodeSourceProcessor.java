 ...
 */
package com.anyilanxin.kunpeng.cluster.dispatch.command.source.node;
...
/**
 * 节点 source 治理命令处理器抽象基类。
 *
 * @author zxuanhong
 * @since 2026.9.0
 */
public abstract class AbstractNodeSourceProcessor
    implements LogEventProcessorSingleState<NodeSourceRecord> {
  protected final LogEventWriter writer;

  public AbstractNodeSourceProcessor(final LogEventWriter writer) {
    this.writer = writer;
  }
  ...
  @Override
  public abstract NodeSourceLifeCycle valueLifeCycle();
}
