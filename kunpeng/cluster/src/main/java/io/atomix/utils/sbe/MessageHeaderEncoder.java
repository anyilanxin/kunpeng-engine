...
public final class MessageHeaderEncoder {
  ...
  /** Wraps this header at the given offset and copies its state into the given encoder. */
  public void copyTo(final MessageHeaderEncoder other) {
    other.wrap(buffer, offset)
        .blockLength(buffer.getShort(offset + 0, java.nio.ByteOrder.LITTLE_ENDIAN))
        .templateId(buffer.getShort(offset + 2, java.nio.ByteOrder.LITTLE_ENDIAN))
        .schemaId(buffer.getShort(offset + 4, java.nio.ByteOrder.LITTLE_ENDIAN))
        .version(buffer.getShort(offset + 6, java.nio.ByteOrder.LITTLE_ENDIAN));
  }
