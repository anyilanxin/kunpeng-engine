...
import static io.atomix.raft.metrics.RaftRoleMetricsDoc.ELECTION_LATENCY;
import static io.atomix.raft.metrics.RaftRoleMetricsDoc.ELECTION_TRIGGERED;
import static io.atomix.raft.metrics.RaftRoleMetricsDoc.HEARTBEAT_MISS;
import static io.atomix.raft.metrics.RaftRoleMetricsDoc.HEARTBEAT_TIME;
import static io.atomix.raft.metrics.RaftRoleMetricsDoc.ROLE;
import static io.atomix.raft.metrics.RaftRoleMetricsDoc.TERM;
import static io.atomix.raft.metrics.RaftRoleMetricsDoc.VOTE_GRANTED;
import static io.atomix.raft.metrics.RaftRoleMetricsDoc.VOTE_REJECTED;
