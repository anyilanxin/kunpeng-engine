...
public final class LeadershipTransferInitiateRequest extends AbstractRaftRequest {
  ...
  private final Long replicationLagThreshold;
  private final Duration replicationTimeout;
  private final Integer maxTransferAttempts;
  ...
  private LeadershipTransferInitiateRequest(
      ...
      final Long replicationLagThreshold,
      final Duration replicationTimeout,
      final Integer maxTransferAttempts) {
   ...
   */
  public Long replicationLagThreshold() {
   ...
   */
  public Duration replicationTimeout() {
  ...
  public static class Builder
    ...
    private Long replicationLagThreshold;
