...
/** Raft 日志复制位点指标定义（标签：partitionGroupName、partition） */
public enum RaftReplicationMetricDocs implements CustomMeterDocumentation {
  /** 已提交的日志索引 */
  ...
  RaftReplicationMetricDocs(final String name, final String description, final Type type) {
    this.name = name;
