...
import com.anyilanxin.kunpeng.cluster.raft.journal.record.BinaryRecordSerializer;
...
final class SegmentWriter {
  ...
  private final JournalRecordSerializer serializer = new BinaryRecordSerializer();
