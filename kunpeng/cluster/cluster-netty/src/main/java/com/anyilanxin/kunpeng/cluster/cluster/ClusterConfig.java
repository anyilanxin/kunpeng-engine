...
public class ClusterConfig implements Config {
  ...
  private AeronMessagingConfig aeronConfig = new AeronMessagingConfig();
  ...
  /**
   * Returns the Aeron transport configuration.
   *
   * @return the Aeron transport configuration
   */
  public AeronMessagingConfig getAeronConfig() {
    return aeronConfig;
  }

  /**
   * Sets the Aeron transport configuration.
   *
   * @param aeronConfig the Aeron transport configuration
   * @return the cluster configuration
   */
  public ClusterConfig setAeronConfig(final AeronMessagingConfig aeronConfig) {
    this.aeronConfig = checkNotNull(aeronConfig);
    return this;
  }
}
