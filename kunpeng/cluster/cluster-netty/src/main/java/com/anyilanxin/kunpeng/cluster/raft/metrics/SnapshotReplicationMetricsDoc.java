...
public enum SnapshotReplicationMetricsDoc implements CustomMeterDocumentation {
  ...
  /** 接收到的快照字节数 */
  RECEIVED_BYTES(
      "atomix_snapshot_replication_received_bytes",
      "Bytes of snapshot chunks received from the leader",
      Type.COUNTER),
  /** 接收到的快照分片数 */
  RECEIVED_CHUNKS(
      "atomix_snapshot_replication_received_chunks",
      "Number of snapshot chunks received from the leader",
      Type.COUNTER);
