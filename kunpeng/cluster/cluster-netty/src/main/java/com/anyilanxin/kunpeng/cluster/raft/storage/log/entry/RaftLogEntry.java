...
public record RaftLogEntry(long term, RaftEntry entry) {
  ...
  public boolean isBusinessMetaEntry() {
    return entry instanceof BusinessMetaEntry;
  }

  public BusinessMetaEntry getBusinessMetaEntry() {
    return (BusinessMetaEntry) entry;
  }
