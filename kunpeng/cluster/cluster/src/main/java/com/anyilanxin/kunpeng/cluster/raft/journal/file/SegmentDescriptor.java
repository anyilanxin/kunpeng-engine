 ...
 * SegmentedJournal}. The descriptor is stored in the first bytes of the segment. The first byte
 * contains the descriptor version; the remaining fields are encoded by the current {@link
