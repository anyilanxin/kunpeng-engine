...
public final class JournalRecordData {
  ...
  public JournalRecordData(final long index, final long asqn, final DirectBuffer data) {
    this.index = index;
    this.asqn = asqn;
    this.data = data;
  }
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof JournalRecordData)) {
      return false;
    }
    final JournalRecordData that = (JournalRecordData) o;
  ...
  public String toString() {
    return "JournalRecordData{index=" + index + ", asqn=" + asqn + ", data=" + data + '}';
  }
}
