...
import static com.anyilanxin.kunpeng.cluster.cluster.protocol.SwimMembershipProtocolMetricsDoc.MEMBERS_INCARNATION_NUMBER;
import static com.anyilanxin.kunpeng.cluster.cluster.protocol.SwimMembershipProtocolMetricsDoc.MEMBER_ADDED;
import static com.anyilanxin.kunpeng.cluster.cluster.protocol.SwimMembershipProtocolMetricsDoc.MEMBER_COUNT;
import static com.anyilanxin.kunpeng.cluster.cluster.protocol.SwimMembershipProtocolMetricsDoc.MEMBER_REMOVED;
...
final class SwimMembershipProtocolMetrics {
  ...
  public void updateMemberIncarnationNumber(final String member, final long incarnationNumber) {
    incarnationNumbers
        .computeIfAbsent(
            member, id -> Micrometers.gauge(MEMBERS_INCARNATION_NUMBER, registry, "memberId", id))
