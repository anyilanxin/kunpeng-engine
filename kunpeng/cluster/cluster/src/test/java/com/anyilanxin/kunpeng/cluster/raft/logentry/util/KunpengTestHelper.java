...
public class KunpengTestHelper {
  ...
  private final Collection<KunpengTestNode> nodes;

  public KunpengTestHelper(final Collection<KunpengTestNode> nodes) {
    this.nodes = nodes;
  }

  public LogAppender awaitLeaderAppender(final int partitionId) {
  ...
  public KunpengTestNode awaitLeader(final int partitionId) {
    return await(() -> getLeader(partitionId));
  }

  public KunpengTestNode awaitLeader(final int partitionId, final Collection<KunpengTestNode> nodes) {
    return await(() -> getLeader(partitionId, nodes));
  }

  public Optional<KunpengTestNode> getLeader(final int partitionId) {
    return getLeader(partitionId, nodes);
  }

  public Optional<KunpengTestNode> getLeader(
      final int partitionId, final Collection<KunpengTestNode> nodes) {
    return nodes.stream()
  ...
  public void awaitAllContains(
      final Collection<KunpengTestNode> nodes,
  ...
  public boolean containsIndexed(
      final KunpengTestNode node, final int partitionId, final IndexedRaftLogEntry indexed) {
