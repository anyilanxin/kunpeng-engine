...
The upstream camunda-bpm-platform repository is no longer actively maintained, while this project needs to iterate quickly. To avoid being blocked on an unmaintained upstream, the DMN engine was imported into this repository so it can be maintained and evolved here.
