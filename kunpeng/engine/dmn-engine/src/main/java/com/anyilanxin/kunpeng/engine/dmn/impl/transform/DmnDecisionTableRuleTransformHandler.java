...
public class DmnDecisionTableRuleTransformHandler
  ...
  public DmnDecisionTableRuleImpl handleElement(final DmnElementTransformContext context, final Rule rule) {
    return createFromRule(context, rule);
  }

  protected DmnDecisionTableRuleImpl createFromRule(final DmnElementTransformContext context, final Rule rule) {
    final DmnDecisionTableRuleImpl decisionTableRule = createDmnElement(context, rule);
  ...
  protected DmnDecisionTableRuleImpl createDmnElement(
    final DmnElementTransformContext context, final Rule rule) {
