...
public interface DmnBusinessKnowledgeLogicEvaluationEvent {

  /**
   * @return the evaluated business knowledge
   */
  DmnBusinessKnowledge getBusinessKnowledge();

  /**
   * @return the number of executed decision elements during the evaluation
   */
  long getExecutedBusinessKnowledgeElements();
}
