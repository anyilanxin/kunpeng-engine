...
public class DmnDecisionTransformHandler
  ...
  public DmnDecisionImpl handleElement(final DmnElementTransformContext context, final Decision decision) {
    return createFromDecision(context, decision);
  }

  protected DmnDecisionImpl createFromDecision(
    final DmnElementTransformContext context, final Decision decision) {
    final DmnDecisionImpl decisionEntity = createDmnElement();
