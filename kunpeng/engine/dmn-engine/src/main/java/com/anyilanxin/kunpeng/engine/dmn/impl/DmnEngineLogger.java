...
import com.anyilanxin.kunpeng.engine.dmn.DmnDecisionRuleResult;
...
public class DmnEngineLogger extends DmnLogger {
  ...
  public DmnTransformException unableToFindDecisionWithKey(String decisionKey) {
    return new DmnTransformException(
        exceptionMessage("001", "Unable to find decision with id '{}' in model.", decisionKey));
  }

  public DmnEvaluationException unableToEvaluateExpression(
      String expression, String expressionLanguage, Throwable cause) {
  ...
  public DmnDecisionResultException decisionOutputHasMoreThanOneValue(
      DmnDecisionRuleResult ruleResult) {
