...
public class DmnTransformLogger extends DmnLogger {
  ...
  public DmnTransformException differentNumberOfInputsAndInputEntries(
      int inputsSize, int inputEntriesSize, DmnDecisionTableRuleImpl rule) {
    return new DmnTransformException(
        exceptionMessage(
            "005",
  ...
  public DmnTransformException differentNumberOfOutputsAndOutputEntries(
      int outputsSize, int outputEntriesSize, DmnDecisionTableRuleImpl rule) {
    return new DmnTransformException(
        exceptionMessage(
            "006",
  ...
  public DmnTransformException decisionTableInputIdIsMissing(
      DmnDecision dmnDecision, DmnDecisionTableInputImpl dmnDecisionTableInput) {
    return new DmnTransformException(
        exceptionMessage(
            "011",
  ...
  public DmnTransformException decisionTableOutputIdIsMissing(
      DmnDecision dmnDecision, DmnDecisionTableOutputImpl dmnDecisionTableOutput) {
    return new DmnTransformException(
        exceptionMessage(
            "012",
  ...
  public DmnTransformException decisionTableRuleIdIsMissing(
      DmnDecision dmnDecision, DmnDecisionTableRuleImpl dmnDecisionTableRule) {
    return new DmnTransformException(
        exceptionMessage(
            "013",
