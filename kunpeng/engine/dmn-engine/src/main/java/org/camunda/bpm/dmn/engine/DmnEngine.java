...
public interface DmnEngine {
   ...
   * @throws DmnEngineException if an error occurs during the parsing of the decision model
   */
  ...
  /**
   * Parse the decision with the given key in a DMN decision model. The key is the {@code id}
   * attribute of the decision in the DMN XML file.
   *
   ...
   * @param variables the variables which are available during the evaluation of expressions in the
   *     decision table
   * @return the {@link DmnDecisionTableResult} of this evaluation
   * @throws DmnEngineException if the decision is not implemented as decision table (see {@link
   *     DmnDecision#isDecisionTable()}
   * @throws DmnEngineException if an error occurs during the evaluation
   ...
   *
   * @param decision the {@link DmnDecision} to evaluate
   * @param variableContext the variables context which is available during the evaluation of
   *     expressions in the decision table
   * @return the {@link DmnDecisionTableResult} of this evaluation
   * @throws DmnEngineException if the decision is not implemented as decision table (see {@link
   *     DmnDecision#isDecisionTable()}
   * @throws DmnEngineException if an error occurs during the evaluation
   ...
   */
  DmnDecisionTableResult evaluateDecisionTable(
      DmnDecision decision, VariableContext variableContext);

  /**
   * Evaluates the decision with the given key in a DMN decision model. The key is the {@code id}
   * attribute of the decision in the DMN XML file.
   *
   ...
   *     decision table
   * @return the {@link DmnDecisionTableResult} of this evaluation
   * @throws DmnEngineException if no decision is found with the given key
   * @throws DmnEngineException if the decision is not implemented as decision table
   * @throws DmnEngineException if an error occurs during the evaluation
   * @see #evaluateDecision(String, InputStream, Map)
   */
  DmnDecisionTableResult evaluateDecisionTable(
      String decisionKey, InputStream inputStream, Map<String, Object> variables);
   ...
   */
  DmnDecisionTableResult evaluateDecisionTable(
      String decisionKey, InputStream inputStream, VariableContext variableContext);
   ...
   */
  DmnDecisionTableResult evaluateDecisionTable(
      String decisionKey, DmnModelInstance dmnModelInstance, Map<String, Object> variables);
   ...
   */
  DmnDecisionTableResult evaluateDecisionTable(
      String decisionKey, DmnModelInstance dmnModelInstance, VariableContext variableContext);
   ...
   * @throws DmnEngineException if the decision logic is not supported
   * @throws DmnEngineException if an error occurs during the evaluation
   */
  ...
  /**
   * Evaluates the decision with the given key in a DMN decision model. The key is the {@code id}
   * attribute of the decision in the DMN XML file. The decision can be implemented as any kind of
   * supported decision logic (e.g., decision table, literal expression).
   *
   * @param decisionKey the key of the decision to evaluated
   * @param inputStream the {@link InputStream} of the DMN file
   * @param variables the variables which are available during the evaluation of expressions in the
