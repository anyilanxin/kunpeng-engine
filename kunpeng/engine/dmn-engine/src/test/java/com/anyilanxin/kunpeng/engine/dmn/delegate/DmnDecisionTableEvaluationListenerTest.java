 ...
 */
package com.anyilanxin.kunpeng.engine.dmn.delegate;
...
import com.anyilanxin.kunpeng.engine.dmn.impl.hitpolicy.DefaultHitPolicyHandlerRegistry;
...
public class DmnDecisionTableEvaluationListenerTest extends DmnEngineTest {
  ...
  public void initListener() {
    final TestDecisionTableEvaluationListenerConfiguration configuration = (TestDecisionTableEvaluationListenerConfiguration) dmnEngine.getConfiguration();
  ...
  public void testInputValues() {
    ...
    final List<DmnEvaluatedInput> inputs = listener.evaluationEvent.getInputs();
    assertThat(inputs).hasSize(3);

    final DmnEvaluatedInput input1 = inputs.get(0);
    ...
    final DmnEvaluatedInput input2 = inputs.get(1);
    ...
    final DmnEvaluatedInput input3 = inputs.get(2);
  ...
  public void testOutputs() {
    ...
    final DmnEvaluatedOutput output1 = outputs.get("out1");
  ...
  public void testCollectResult() {
    ...
    final List<DmnEvaluatedDecisionRule> matchingRules = listener.evaluationEvent.getMatchingRules();
  ...
  public void setDecisionTableHitPolicy(final HitPolicy hitPolicy, final BuiltinAggregator aggregator) {
    final DmnHitPolicyHandler handler = hitPolicyHandlerRegistry.getHandler(hitPolicy, aggregator);
    assertThat(handler).isNotNull();
    final DmnDecisionTableImpl decisionTable = (DmnDecisionTableImpl) this.decision.getDecisionLogic();
    decisionTable.setHitPolicyHandler(handler);
  }

  public DmnDecisionTableResult evaluateDecisionTable(final Object input1, final Object input2, final Object input3, final Object output1) {
  ...
  public static class TestDecisionTableEvaluationListener implements DmnDecisionTableEvaluationListener {
    ...
    public void notify(final DmnDecisionTableEvaluationEvent evaluationEvent) {
