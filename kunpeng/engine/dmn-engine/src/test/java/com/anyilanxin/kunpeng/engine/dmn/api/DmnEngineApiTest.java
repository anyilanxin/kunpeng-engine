...
import com.anyilanxin.kunpeng.engine.dmn.DmnEngineException;
...
import com.anyilanxin.kunpeng.engine.dmn.impl.DmnEvaluationException;
...
public class DmnEngineApiTest extends DmnEngineTest {
  ...
  public void shouldFailEvaluatingDecisionTableWithEmptyVariableMap() {
    ...
    catch(final DmnEvaluationException e) {
  ...
  public void shouldFailEvaluatingDecisionTableIfDecisionIsNotATable() {
    ...
    catch(final DmnEngineException e) {
  ...
  public void shouldFailEvaluatingDecisionIfDecisionLogicIsNotSupported() {
    final DmnDecisionImpl decision = new DmnDecisionImpl();
  ...
  public void shouldEvaluateDecisionTableWithVariableMap() {
    final DmnDecisionTableResult results = dmnEngine.evaluateDecisionTable(decision, createVariables().putValue("input", INPUT_VALUE));
    assertThat(results)
      .hasSingleResult()
  ...
  public void shouldEvaluateDecisionTableWithVariableContext() {
    final DmnDecisionTableResult results = dmnEngine.evaluateDecisionTable(decision, createVariables().putValue("input", INPUT_VALUE).asVariableContext());
    assertThat(results)
      .hasSingleResult()
      .hasSingleEntry(EXPECTED_OUTPUT_VALUE);
  }
  ...
  public void shouldEvaluateDecisionWithVariableMap() {
    final DmnDecisionResult results = dmnEngine.evaluateDecision(decision, createVariables().putValue("input", INPUT_VALUE));
  ...
  public void shouldEvaluateDecisionWithVariableContext() {
    final DmnDecisionResult results = dmnEngine.evaluateDecision(decision, createVariables().putValue("input", INPUT_VALUE).asVariableContext());
  ...
  public void shouldEvaluateDecisionOfDrg() {
    final DmnDecisionRequirementsGraph drd = dmnEngine.parseDecisionRequirementsGraph(createInputStream());
