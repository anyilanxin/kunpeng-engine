 ...
 * @since 2026.9.0
 */
public class ActivateProcessDefinitionDistributeProcessor
    extends LogEventDistributeProcessor<ProcessDefinitionRecord> {
  final LogEventWriter writer;

  public ActivateProcessDefinitionDistributeProcessor(final LogEventWriter writer) {
    super(writer);
    this.writer = writer;
  }
  ...
  public ValueLifeCycle processRecordNewLifeCycle() {
    return ProcessDefinitionLifeCycle.ACTIVATE;
  }
  ...
  public ValueLifeCycle processRecordDistributeAfterLifeCycle() {
    return ProcessDefinitionLifeCycle.ACTIVATED_DISTRIBUTE_AFTER;
  }
}
