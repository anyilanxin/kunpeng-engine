 ...
 * @since 2026.9.0
 */
public class BpmnProcessElementStartListenerProcessor extends BpmnProcessElementListenerProcessor {

  public BpmnProcessElementStartListenerProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public ProcessInstanceListenerType getType() {
    return ProcessInstanceListenerType.START;
  }

  @Override
  public List<BpmnExecutionListener> getExecutionListeners(final BpmnProcess element) {
    return element.getExecutionListeners(KunpengExecutionListenerEventType.start);
  }
