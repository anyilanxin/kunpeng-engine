 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskOwnProcessor extends BpmnUserTaskElementAbstractProcessor {

  public BpmnUserTaskOwnProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public UserTaskLifeCycle processState() {
    return UserTaskLifeCycle.OWN;
  }
