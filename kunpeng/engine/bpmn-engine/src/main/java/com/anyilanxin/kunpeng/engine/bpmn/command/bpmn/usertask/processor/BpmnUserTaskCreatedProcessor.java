 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskCreatedProcessor extends BpmnUserTaskElementAbstractProcessor {

  public BpmnUserTaskCreatedProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public UserTaskLifeCycle processState() {
    return UserTaskLifeCycle.CREATED;
  }
  ...
  public void process(
    ...
    value.setLifeCycle(UserTaskLifeCycle.CREATED);
    writer.addEvent(value.getTaskId(), UserTaskLifeCycle.CREATED, logRecord.getRequestId(), value);
  }
}
