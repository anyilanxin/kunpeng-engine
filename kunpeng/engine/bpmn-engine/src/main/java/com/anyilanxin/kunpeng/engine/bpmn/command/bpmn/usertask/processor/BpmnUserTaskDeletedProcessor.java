 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskDeletedProcessor extends BpmnUserTaskElementAbstractProcessor {

  public BpmnUserTaskDeletedProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public UserTaskLifeCycle processState() {
    return UserTaskLifeCycle.DELETED;
  }
