...
public interface CommandCollector {
   ...
   */
  default boolean appendCommand(final ValueLifeCycle lifeCycle, final UnifiedRecordValue value) {
  ...
  default boolean appendCommand(
      final long key, final ValueLifeCycle lifeCycle, final UnifiedRecordValue value) {
