...
public final class Loggers {
  ...
  public static final Logger BPMN_LOGGER =
      LoggerFactory.getLogger("com.anyilanxin.kunpeng.engine.bpmn");
  ...
  public static final Logger TEST_INFO_LOGGER =
      LoggerFactory.getLogger("com.anyilanxin.kunpeng.test");
