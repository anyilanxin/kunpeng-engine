 ...
 * @since 2026.9.0
 */
public abstract class VariableApiAbstractProcessor<T extends UnifiedRecordValue>
  ...
  public VariableApiAbstractProcessor(final LogEventWriter writer) {
    this.writer = writer;
  ...
  @Override
  public abstract CommandApiVariableValueLifeCycle valueLifeCycle();
}
