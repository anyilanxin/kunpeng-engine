 ...
 * @since 2026.9.0
 */
public class DeleteProcessDefinitionApiProcessor
    extends ProcessDefinitionApiAbstractProcessor<ProcessDefinitionDeleteRequestRecord> {
  private final ProcessDefinitionDeleteResponseRecord response =
      new ProcessDefinitionDeleteResponseRecord();

  public DeleteProcessDefinitionApiProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public void innerProcessRecord(
      final BusinessLogRecord<ProcessDefinitionDeleteRequestRecord> record,
      final ProcessDefinitionRecord definitionRecord) {}

  @Override
  public CommandApiProcessDefinitionValueLifeCycle valueLifeCycle() {
    return CommandApiProcessDefinitionValueLifeCycle.DELETE_REQUEST;
  }
}
