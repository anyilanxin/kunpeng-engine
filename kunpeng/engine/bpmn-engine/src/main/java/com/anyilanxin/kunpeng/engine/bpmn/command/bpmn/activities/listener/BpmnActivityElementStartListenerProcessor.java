 ...
 * @since 2026.9.0
 */
public class BpmnActivityElementStartListenerProcessor
    extends BpmnActivityElementListenerProcessor<BpmnFlowNode> {

  public BpmnActivityElementStartListenerProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public ActivityInstanceListenerType getType() {
    return ActivityInstanceListenerType.START;
  }
