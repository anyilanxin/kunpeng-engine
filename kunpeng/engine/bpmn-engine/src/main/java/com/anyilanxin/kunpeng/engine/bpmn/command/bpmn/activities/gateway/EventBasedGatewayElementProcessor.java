 ...
 * @since 2026.9.0
 */
public class EventBasedGatewayElementProcessor
    implements BpmnActivityElementProcessor<BpmnEventBasedGateway> {
  ...
  public EventBasedGatewayElementProcessor(final LogEventWriter writer) {
    this.writer = writer;
  ...
  @Override
  public Class<BpmnEventBasedGateway> getType() {
    return BpmnEventBasedGateway.class;
  }

  @Override
  public void onActivating(
      final BpmnEventBasedGateway element, final ActivityContent activityContext) {
