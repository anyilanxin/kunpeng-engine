 ...
 * @since 2026.9.0
 */
public class UserTaskDeleteProcessor
    extends UserTaskApiAbstractProcessor<UserTaskDeleteRequestRecord> {
  ...
  public UserTaskDeleteProcessor(final LogEventWriter writer) {
  ...
  public void innerProcessRecord(
      final BusinessLogRecord<UserTaskDeleteRequestRecord> record, final UserTaskRecord userTask) {}

  @Override
  public CommandApiUserTaskValueLifeCycle valueLifeCycle() {
    return CommandApiUserTaskValueLifeCycle.DELETE_REQUEST;
  }
}
