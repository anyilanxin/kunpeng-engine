 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskClaimProcessor extends BpmnUserTaskElementAbstractProcessor {

  public BpmnUserTaskClaimProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public UserTaskLifeCycle processState() {
    return UserTaskLifeCycle.CLAIM;
  }
