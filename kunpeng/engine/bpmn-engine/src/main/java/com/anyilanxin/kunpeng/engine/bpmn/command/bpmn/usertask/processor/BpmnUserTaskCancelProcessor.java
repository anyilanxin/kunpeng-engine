 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskCancelProcessor extends BpmnUserTaskElementAbstractProcessor {

  public BpmnUserTaskCancelProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public UserTaskLifeCycle processState() {
    return UserTaskLifeCycle.CANCEL;
  }
  ...
  public void process(
    ...
    record.setState(UserTaskState.CANCEL);
    record.setLifeCycle(UserTaskLifeCycle.CANCEL);
    writer.addEvent(record.getTaskId(), UserTaskLifeCycle.CANCEL, logRecord.getRequestId(), record);
