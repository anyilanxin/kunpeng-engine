 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskResolveProcessor extends BpmnUserTaskElementAbstractProcessor {

  public BpmnUserTaskResolveProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public UserTaskLifeCycle processState() {
    return UserTaskLifeCycle.RESOLVE;
  }
