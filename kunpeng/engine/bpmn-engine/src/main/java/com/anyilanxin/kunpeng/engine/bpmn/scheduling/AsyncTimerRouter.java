...
public final class AsyncTimerRouter implements AsyncTimerScheduler {
  ...
  @Override
  public TimerScheduler.TimerHandle scheduleAfter(final Duration delay, final TimerJob job) {
    return routeAllToCompute
  ...
  @Override
  public TimerScheduler.TimerHandle scheduleAt(final long epochMilli, final Runnable action) {
    return routeAllToCompute
  ...
  @Override
  public TimerScheduler.TimerHandle scheduleAt(final long epochMilli, final TimerJob job) {
    return routeAllToCompute
  ...
  @Override
  public TimerScheduler.TimerHandle scheduleAfterAsync(final Duration delay, final TimerJob job) {
    return computeLane().scheduleAfter(delay, job);
  }

  @Override
  public TimerScheduler.TimerHandle scheduleAtAsync(final long epochMilli, final TimerJob job) {
