 ...
 */
package com.anyilanxin.kunpeng.engine.bpmn.commandapi.message;
 ...
 * @since 2026.9.0
 */
public abstract class MessageCorrelationApiAbstractProcessor<T extends UnifiedRecordValue>
  ...
  public MessageCorrelationApiAbstractProcessor(final LogEventWriter writer) {
    this.writer = writer;
  ...
  @Override
  public abstract CommandApiMessageValueLifeCycle valueLifeCycle();
}
