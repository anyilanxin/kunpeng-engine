...
import com.anyilanxin.kunpeng.engine.bpmn.commandapi.signal.processor.SignalCorrelationApiProcessor;
 ...
 * @since 2026.9.0
 */
public final class SignalCorrelationApiProcessorRegister {

  public static void registerRepository(
      final LogEventProcessors processors, final LogEventWriter writer) {
    processors.onCommand(new SignalCorrelationApiProcessor(writer));
  }
}
