 ...
 * @since 2026.9.0
 */
public abstract class VariableAbstractProcessor implements LogEventProcessor<VariableRecord> {
  protected final LogEventWriter writer;
  protected final ImmutableJobRepository job;
  protected final ImmutableVariableRepository variable;
  ...
  public VariableAbstractProcessor(final LogEventWriter writer) {
    this.writer = writer;
  ...
  @Override
  public VariableLifeCycle[] valueLifeCycles() {
    return new VariableLifeCycle[] {processState()};
  }

  public abstract VariableLifeCycle processState();
