 ...
 * @since 2026.9.0
 */
public class UserTaskOwnProcessor extends UserTaskApiAbstractProcessor<UserTaskOwnRequestRecord> {
  ...
  public UserTaskOwnProcessor(final LogEventWriter writer) {
  ...
  public void innerProcessRecord(
      final BusinessLogRecord<UserTaskOwnRequestRecord> record, final UserTaskRecord userTask) {}

  @Override
  public CommandApiUserTaskValueLifeCycle valueLifeCycle() {
    return CommandApiUserTaskValueLifeCycle.OWN_REQUEST;
  }
}
