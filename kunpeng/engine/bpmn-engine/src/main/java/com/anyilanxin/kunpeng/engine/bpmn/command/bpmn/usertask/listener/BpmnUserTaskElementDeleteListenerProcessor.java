 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskElementDeleteListenerProcessor
    implements BpmnUserTaskElementListenerProcessor {
  private final LogEventWriter writer;
  private final JobBehavior jobBehavior;

  public BpmnUserTaskElementDeleteListenerProcessor(final LogEventWriter writer) {
    this.writer = writer;
  ...
  public UserTaskListenerType getType() {
    return UserTaskListenerType.DELETE;
  }
