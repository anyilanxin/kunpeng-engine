 ...
 * @since 2026.9.0
 */
public abstract class JobAbstractProcessor implements LogEventProcessor<JobRecord> {
  ...
  public JobAbstractProcessor(final LogEventWriter writer) {
    this.writer = writer;
  ...
  @Override
  public JobLifeCycle[] valueLifeCycles() {
    return new JobLifeCycle[] {processState()};
  }

  public abstract JobLifeCycle processState();
