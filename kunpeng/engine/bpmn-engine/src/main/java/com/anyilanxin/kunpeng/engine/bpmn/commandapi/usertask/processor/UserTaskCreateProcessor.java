 ...
 * @since 2026.9.0
 */
public class UserTaskCreateProcessor
    extends UserTaskApiAbstractProcessor<UserTaskCreateRequestRecord> {
  ...
  public UserTaskCreateProcessor(final LogEventWriter writer) {
  ...
  public void innerProcessRecord(
      final BusinessLogRecord<UserTaskCreateRequestRecord> record, final UserTaskRecord userTask) {}

  @Override
  public CommandApiUserTaskValueLifeCycle valueLifeCycle() {
    return CommandApiUserTaskValueLifeCycle.CREATE_REQUEST;
  }
}
