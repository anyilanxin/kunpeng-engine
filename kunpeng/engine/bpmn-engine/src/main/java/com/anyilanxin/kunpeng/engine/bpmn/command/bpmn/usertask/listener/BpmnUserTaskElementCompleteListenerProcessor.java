 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskElementCompleteListenerProcessor
    implements BpmnUserTaskElementListenerProcessor {
  private final LogEventWriter writer;
  private final JobBehavior jobBehavior;

  public BpmnUserTaskElementCompleteListenerProcessor(final LogEventWriter writer) {
    this.writer = writer;
  ...
  private void toCompleted(final BusinessLogRecord<UserTaskRecord> logRecord) {
    final UserTaskRecord value = logRecord.getValue();
    value.setListenerType(UserTaskListenerType.UNKNOW);
