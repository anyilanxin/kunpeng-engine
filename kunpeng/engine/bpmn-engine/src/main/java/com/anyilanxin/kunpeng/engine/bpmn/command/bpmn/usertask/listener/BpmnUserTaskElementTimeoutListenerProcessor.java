 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskElementTimeoutListenerProcessor
    implements BpmnUserTaskElementListenerProcessor {
  private final LogEventWriter writer;
  private final JobBehavior jobBehavior;

  public BpmnUserTaskElementTimeoutListenerProcessor(final LogEventWriter writer) {
    this.writer = writer;
  ...
  public UserTaskListenerType getType() {
    return UserTaskListenerType.TIMEOUT;
  }
