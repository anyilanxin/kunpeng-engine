 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskAssigneProcessor extends BpmnUserTaskElementAbstractProcessor {

  public BpmnUserTaskAssigneProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public UserTaskLifeCycle processState() {
    return UserTaskLifeCycle.ASSIGNEE;
  }
