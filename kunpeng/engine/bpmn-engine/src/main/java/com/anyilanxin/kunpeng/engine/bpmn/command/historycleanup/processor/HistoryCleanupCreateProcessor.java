 ...
 * @since 2026.9.0
 */
public final class HistoryCleanupCreateProcessor extends HistoryCleanupAbstractProcessor {

  public HistoryCleanupCreateProcessor(final LogEventWriter writer) {
    super(writer);
  }
  ...
  public HistoryCleanupLifeCycle valueLifeCycle() {
    return HistoryCleanupLifeCycle.CREATE;
  }
}
