 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskDeleteProcessor extends BpmnUserTaskElementAbstractProcessor {

  public BpmnUserTaskDeleteProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public UserTaskLifeCycle processState() {
    return UserTaskLifeCycle.DELETE;
  }
