 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskUpdatedProcessor extends BpmnUserTaskElementAbstractProcessor {

  public BpmnUserTaskUpdatedProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public UserTaskLifeCycle processState() {
    return UserTaskLifeCycle.UPDATED;
  }
