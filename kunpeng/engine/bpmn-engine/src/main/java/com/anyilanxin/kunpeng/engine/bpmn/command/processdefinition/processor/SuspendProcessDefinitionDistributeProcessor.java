 ...
 * @since 2026.9.0
 */
public class SuspendProcessDefinitionDistributeProcessor
    extends LogEventDistributeProcessor<ProcessDefinitionRecord> {

  final LogEventWriter writer;

  public SuspendProcessDefinitionDistributeProcessor(final LogEventWriter writer) {
    super(writer);
    this.writer = writer;
  }
  ...
  public ValueLifeCycle processRecordNewLifeCycle() {
    return ProcessDefinitionLifeCycle.SUSPEND;
  }

  @Override
  public ValueLifeCycle processRecordDistributeLifeCycle() {
    return ProcessDefinitionLifeCycle.SUSPENDED_DISTRIBUTE;
  }

  @Override
  public ValueLifeCycle processRecordDistributeAfterLifeCycle() {
    return ProcessDefinitionLifeCycle.SUSPENDED_DISTRIBUTE_AFTER;
  }
}
