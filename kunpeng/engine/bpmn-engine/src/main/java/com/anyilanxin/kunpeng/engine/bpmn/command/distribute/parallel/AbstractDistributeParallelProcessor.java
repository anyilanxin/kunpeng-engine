 ...
 * @since 2026.9.0
 */
public abstract class AbstractDistributeParallelProcessor
    implements LogEventProcessorSingleState<DistributeParallelRecord> {
  @Override
  ...
  @Override
  public abstract DistributeParallelLifeCycle valueLifeCycle();
}
