 ...
 * @since 2026.9.0
 */
public class UserTaskDelegateProcessor
    extends UserTaskApiAbstractProcessor<UserTaskDelegateRequestRecord> {
  ...
  public UserTaskDelegateProcessor(final LogEventWriter writer) {
  ...
  public void innerProcessRecord(
      final BusinessLogRecord<UserTaskDelegateRequestRecord> record,
      final UserTaskRecord userTask) {}

  @Override
  public CommandApiUserTaskValueLifeCycle valueLifeCycle() {
    return CommandApiUserTaskValueLifeCycle.DELEGATE_REQUEST;
  }
}
