 ...
 * @since 2026.9.0
 */
public class BpmnUserTaskElementUpdateListenerProcessor
    implements BpmnUserTaskElementListenerProcessor {
  private final LogEventWriter writer;
  private final JobBehavior jobBehavior;

  public BpmnUserTaskElementUpdateListenerProcessor(final LogEventWriter writer) {
    this.writer = writer;
  ...
  public UserTaskListenerType getType() {
    return UserTaskListenerType.UPDATE;
  }
