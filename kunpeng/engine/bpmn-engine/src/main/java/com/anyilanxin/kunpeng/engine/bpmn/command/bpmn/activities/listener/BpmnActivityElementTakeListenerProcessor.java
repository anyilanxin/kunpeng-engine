 ...
 * @since 2026.9.0
 */
public class BpmnActivityElementTakeListenerProcessor
    extends BpmnActivityElementListenerProcessor<BpmnSequenceFlow> {

  public BpmnActivityElementTakeListenerProcessor(final LogEventWriter writer) {
    super(writer);
  }

  @Override
  public ActivityInstanceListenerType getType() {
    return ActivityInstanceListenerType.TAKE;
  }

  @Override
  public List<BpmnExecutionListener> getExecutionListeners(final BpmnSequenceFlow element) {
    return element.getExecutionListeners(KunpengExecutionListenerEventType.take);
  }
