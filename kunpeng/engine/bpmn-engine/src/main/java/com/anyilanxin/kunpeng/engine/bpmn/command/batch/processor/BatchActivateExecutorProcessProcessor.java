 ...
 * @since 2026.9.0
 */
public class BatchActivateExecutorProcessProcessor extends AbstractBatchProcessor {

  public BatchActivateExecutorProcessProcessor(final LogEventWriter writer) {
    super(writer);
  }
