...
public final class SchedulerLoggers {
  ...
  public static final Logger SCHEDULER_LOGGER =
      LoggerFactory.getLogger("com.anyilanxin.kunpeng.scheduler");
  public static final Logger FUTURE_LOGGER =
      LoggerFactory.getLogger("com.anyilanxin.kunpeng.scheduler.future");

  private SchedulerLoggers() {}
}
