...
import static com.anyilanxin.kunpeng.eventlog.impl.EventLogMetricsDoc.FLOW_EVICTED;
...
public final class EventLogMetrics {
  ...
  public EventLogMetrics(
    ...
    this.logTag = logName;
    if (registry == null) {
      appended = rejectedWindow = rejectedInvalid = burned = commitCount = evicted = null;
      return;
    }
    ...
    evicted = counter(FLOW_EVICTED, tags);
  ...
  public void incEvicted(final long batches) {
    if (evicted != null) {
      evicted.increment(batches);
    }
  }
