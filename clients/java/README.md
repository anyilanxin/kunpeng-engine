# kunpeng-clients-java Change Notes

[中文](./README.zh-CN.md)

The code in this module originates from the java client module of the Camunda 8 / Zeebe repository:
...
1. The module was imported as-is: the upstream `io.camunda.client.*` packages, the Maven `pom.xml` and
   the QA configs (spotbugs, revapi) are preserved unchanged at this stage.
