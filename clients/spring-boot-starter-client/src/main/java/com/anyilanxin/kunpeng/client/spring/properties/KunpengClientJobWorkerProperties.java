 ...
 * @since 2026.9.0
 */
public class KunpengClientJobWorkerProperties {
   ...
   * KunpengClientWorkerProperties#getOverride()}.
   */
  public KunpengClientJobWorkerProperties() {
    this(false);
  }

  /**
   * This instantiates the properties optionally with defaults if set to <code>true</code>. Intended
   * to be used by {@link KunpengClientWorkerProperties#getDefaults()}.
   *
   * @param initWithDefaults whether default properties should be set on creation
   */
  public KunpengClientJobWorkerProperties(final boolean initWithDefaults) {
    if (initWithDefaults) {
