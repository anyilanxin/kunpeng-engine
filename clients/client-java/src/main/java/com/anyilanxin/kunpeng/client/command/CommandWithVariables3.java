...
public abstract class CommandWithVariables3<T> {

  protected final JsonMapper objectMapper;

  public CommandWithVariables3(final JsonMapper jsonMapper) {
  ...
  protected abstract T setLocalVariablesInternal(String localVariables);
