...
public interface CreateProcessInstanceCommand {
   ...
   *
   * @param processDefinitionKey the BPMN process id of the process
   * @return the builder for this command
   */
  CreateProcessInstanceCommandStep2 processDefinitionKey(String processDefinitionKey);
   ...
   *
   * @param processDefinitionId the key of the process
   * @return the builder for this command
   */
  CreateProcessInstanceCommandStep3 processDefinitionId(long processDefinitionId);
  ...
  interface CreateProcessInstanceCommandStep3
      extends CommandWithTenantStep<CreateProcessInstanceCommandStep3>,
          FinalCommandStep<CreateProcessInstanceCommandResponse>,
     ...
     *
     * @param activityDefinitionKey the id of the BPMN element where to start the process instance
     * @return the builder for this command. Call {@link #send()} to complete the command and send
     *     it to the broker.
     */
    CreateProcessInstanceCommandStep3 startBeforeElement(final String activityDefinitionKey);
     ...
     * instructions.
     *
     * @param activityDefinitionKey the id of the BPMN element after which the process instance
     *     should be terminated
     * @return the builder for this command. Call {@link #send()} to complete the command and send
     *     it to the broker
     */
    CreateProcessInstanceCommandStep3 terminateAfterElement(final String activityDefinitionKey);
  ...
  interface CreateProcessInstanceWithResultCommandStep1
      extends CommandWithTenantStep<CreateProcessInstanceWithResultCommandStep1>,
          FinalCommandStep<CreateProcessInstanceWithResultCommandResponse> {
