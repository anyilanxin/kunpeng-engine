...
import com.anyilanxin.kunpeng.client.InternalClientException;
 ...
 * JSON format. The default implementation is {@link KunpengObjectMapper}. This interface could be
 ...
 *   }
 *   ...
 *   KunpengClient.newClientBuilder().withJsonMapper(new MyJsonMapper());
 * </pre>
 *
 * <p>Null values won't pass in the JSON with variables: {@code { "a": "b" } }
 *
 * @see KunpengObjectMapper
 */
