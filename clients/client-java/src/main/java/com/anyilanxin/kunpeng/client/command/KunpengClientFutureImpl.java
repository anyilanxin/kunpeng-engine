...
public class KunpengClientFutureImpl<ClientResponse, BrokerResponse>
    extends CompletableFuture<ClientResponse>
    implements KunpengFuture<ClientResponse>,
  ...
  public KunpengClientFutureImpl() {
    this(brokerResponse -> null);
  }

  public KunpengClientFutureImpl(final Function<BrokerResponse, ClientResponse> responseMapper) {
  ...
  public ClientResponse join() {
    try {
      final ClientResponse clientResponse = get();
