...
public class KunpengStreamingClientFutureImpl<ClientResponse, BrokerResponse>
    extends KunpengClientFutureImpl<ClientResponse, BrokerResponse> {

  private final ClientResponse response;
  private final Consumer<BrokerResponse> collector;

  public KunpengStreamingClientFutureImpl(
