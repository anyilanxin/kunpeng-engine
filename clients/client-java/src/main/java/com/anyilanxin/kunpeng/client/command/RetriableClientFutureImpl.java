...
public final class RetriableClientFutureImpl<R, T> extends KunpengClientFutureImpl<R, T> {
  ...
  public void onError(final Throwable throwable) {
    ...
    final CredentialsProvider.StatusCode statusCode = new GrpcStatusCode(status.getCode());
