...
public final class KunpengCallCredentials extends io.grpc.CallCredentials {
  private static final Logger LOG = LoggerFactory.getLogger(KunpengCallCredentials.class);

  private final CredentialsProvider credentialsProvider;
  private boolean securityWarningIssued;

  KunpengCallCredentials(final CredentialsProvider credentialsProvider) {
